...
const prompt = ai.definePrompt({
  ...
  Finance, Health & Fitness, Home Improvement, Engineering, Education, Technology, Travel & Distance, Cooking & Food, Environment, Personal Budgeting, Business & Startup, Crypto & Web3, Parenting, Sports & Training, DIY & Crafts, Time & Date, Gardening, Fun & Games, Data & Statistics, Miscellaneous.
