...
export const calculators: Calculator[] = [
  ...
  },
  {
    ...
    description: 'Estimate your VO₂ max, a key indicator of cardiovascular fitness, based on your resting heart rate and age.',
  ...
  },
  {
    ...
    description: 'Calculate your running pace, finish time, or distance by inputting the other two variables.',
  ...
  },
  {
    ...
    description: 'Estimate calories burned during a run based on body weight, duration, and speed.',
  ...
  },
  {
    ...
    description: 'Get a rough estimate of the power you are generating in watts while cycling.',
  ...
  },
  {
    ...
    description: 'A simple utility to calculate average lap time, total swim time, or number of laps.',
  ...
  },
  {
    ...
    description: 'Calculate a rower\'s "split" (time per 500m), a standard measure of pace in rowing.',
  ...
  },
  {
    ...
    description: 'Estimate energy expenditure for hundreds of activities using Metabolic Equivalent of Task (MET) values.',
  ...
  },
  {
    ...
    description: 'Estimate the maximum weight you can lift for one repetition based on a multi-rep set.',
  ...
  },
  {
    ...
    description: 'Calculate your relative strength by comparing your max lift to your body weight.',
  ...
  },
  {
    ...
    description: 'Quantify your total workout workload by calculating sets x reps x weight.',
