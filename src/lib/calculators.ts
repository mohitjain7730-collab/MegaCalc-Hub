...
export const calculators: Calculator[] = [
  ...
  { id: 3026, name: 'Pregnancy Weight Gain Calculator', description: 'Calculate appropriate pregnancy weight gain based on pre-pregnancy BMI and gestational age.', slug: 'pregnancy-weight-gain-calculator', category: 'health-fitness' },
  { id: 3027, name: 'Due Date Calculator', description: 'Calculate pregnancy due date using LMP, conception date, or ultrasound dating.', slug: 'due-date-calculator', category: 'health-fitness' },
  { id: 3028, name: 'Fertility Ovulation Calculator', description: 'Calculate ovulation dates, fertile windows, and fertility scores based on menstrual cycles.', slug: 'fertility-ovulation-calculator', category: 'health-fitness' },
  { id: 3029, name: 'Breastfeeding Calorie Needs Calculator', description: 'Calculate daily calorie needs for breastfeeding mothers based on activity level and feeding frequency.', slug: 'breastfeeding-calorie-needs-calculator', category: 'health-fitness' },
  { id: 3030, name: 'Infant Growth Percentile Calculator', description: 'Calculate infant growth percentiles for weight, height, and head circumference using WHO standards.', slug: 'infant-growth-percentile-calculator', category: 'health-fitness' },
  { id: 3031, name: 'Child BMI Percentile Calculator', description: 'Calculate child BMI percentiles using CDC growth charts with age and gender-specific assessments.', slug: 'child-bmi-percentile-calculator', category: 'health-fitness' },
