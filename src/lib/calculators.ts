...
export const calculators: Calculator[] = [
  ...
  { id: 500, name: 'Iron Intake Calculator', description: 'Estimate your daily iron intake from various food sources.', slug: 'iron-intake-calculator', category: 'health-fitness' },
  { id: 501, name: 'Calcium Intake Calculator', description: 'Track your daily calcium intake to ensure you meet dietary recommendations.', slug: 'calcium-intake-calculator', category: 'health-fitness' },
  { id: 502, name: 'Zinc Requirement Calculator', description: 'Determine your recommended daily zinc intake based on age and sex.', slug: 'zinc-requirement-calculator', category: 'health-fitness' },
  { id: 503, name: 'Magnesium Intake Calculator', description: 'Assess your daily magnesium intake against recommended dietary allowances.', slug: 'magnesium-intake-calculator', category: 'health-fitness' },
  { id: 504, name: 'Fiber Intake Calculator', description: 'Calculate your daily fiber intake to promote digestive health.', slug: 'fiber-intake-calculator', category: 'health-fitness' },
  { id: 505, name: 'Sodium-to-Potassium Ratio Calculator', description: 'Analyze your dietary sodium-to-potassium ratio, a key indicator for cardiovascular health.', slug: 'sodium-to-potassium-ratio-calculator', category: 'health-fitness' },
  { id: 506, name: 'Daily Antioxidant (ORAC) Goal Calculator', description: 'Estimate a target for daily antioxidant consumption based on ORAC values.', slug: 'daily-antioxidant-orac-goal-calculator', category: 'health-fitness' },
  { id: 507, name: 'Food Protein Digestibility Corrected Amino Acid Score (PDCAAS) Calculator', description: 'Evaluate the quality of a protein based on its amino acid profile and digestibility.', slug: 'food-protein-digestibility-corrected-amino-acid-score-pdcaas-calculator', category: 'health-fitness' },
  { id: 508, name: 'Vitamin D Sun Exposure Calculator', description: 'Estimate the amount of Vitamin D your body might produce based on sun exposure time and skin type.', slug: 'vitamin-d-sun-exposure-calculator', category: 'health-fitness' },
  { id: 509, name: 'Training Stress Score (TSS) Calculator', description: 'Quantify the training load and physiological stress of a workout.', slug: 'training-stress-score-tss-calculator', category: 'health-fitness' },
  // Conversions
