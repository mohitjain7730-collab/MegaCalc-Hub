...
export const calculators: Calculator[] = [
  ...
  // Length Conversions
  { id: 300, name: 'Meters to Feet Converter', description: 'Convert meters to feet.', slug: 'meters-to-feet-converter', category: 'length-conversions' },
  { id: 301, name: 'Feet to Meters Converter', description: 'Convert feet to meters.', slug: 'feet-to-meters-converter', category: 'length-conversions' },
  { id: 302, name: 'Centimeters to Inches Converter', description: 'Convert centimeters to inches.', slug: 'centimeters-to-inches-converter', category: 'length-conversions' },
  { id: 303, name: 'Inches to Centimeters Converter', description: 'Convert inches to centimeters.', slug: 'inches-to-centimeters-converter', category: 'length-conversions' },
  { id: 304, name: 'Millimeters to Inches Converter', description: 'Convert millimeters to inches.', slug: 'millimeters-to-inches-converter', category: 'length-conversions' },
  { id: 305, name: 'Inches to Millimeters Converter', description: 'Convert inches to millimeters.', slug: 'inches-to-millimeters-converter', category: 'length-conversions' },
  { id: 306, name: 'Meters to Yards Converter', description: 'Convert meters to yards.', slug: 'meters-to-yards-converter', category: 'length-conversions' },
  { id: 307, name: 'Yards to Meters Converter', description: 'Convert yards to meters.', slug: 'yards-to-meters-converter', category: 'length-conversions' },
  { id: 308, name: 'Miles to Kilometers Converter', description: 'Convert miles to kilometers.', slug: 'miles-to-kilometers-converter', category: 'length-conversions' },
  { id: 309, name: 'Kilometers to Miles Converter', description: 'Convert kilometers to miles.', slug: 'kilometers-to-miles-converter', category: 'length-conversions' },
  { id: 310, name: 'Nautical Miles to Kilometers Converter', description: 'Convert nautical miles to kilometers.', slug: 'nautical-miles-to-kilometers-converter', category: 'length-conversions' },
  { id: 311, name: 'Kilometers to Nautical Miles Converter', description: 'Convert kilometers to nautical miles.', slug: 'kilometers-to-nautical-miles-converter', category: 'length-conversions' },
  { id: 312, name: 'Micrometers to Millimeters Converter', description: 'Convert micrometers to millimeters.', slug: 'micrometers-to-millimeters-converter', category: 'length-conversions' },
  { id: 313, name: 'Nanometers to Meters Converter', description: 'Convert nanometers to meters.', slug: 'nanometers-to-meters-converter', category: 'length-conversions' },
  { id: 314, name: 'Light Years to Kilometers Converter', description: 'Convert light years to kilometers.', slug: 'light-years-to-kilometers-converter', category: 'length-conversions' },
  { id: 315, name: 'Parsecs to Light Years Converter', description: 'Convert parsecs to light years.', slug: 'parsecs-to-light-years-converter', category: 'length-conversions' },
  { id: 316, name: 'Astronomical Units to Kilometers Converter', description: 'Convert AU to kilometers.', slug: 'astronomical-units-to-kilometers-converter', category: 'length-conversions' },
  { id: 317, name: 'Fathoms to Meters Converter', description: 'Convert fathoms to meters.', slug: 'fathoms-to-meters-converter', category: 'length-conversions' },
  { id: 318, name: 'Chains to Meters Converter', description: 'Convert chains to meters.', slug: 'chains-to-meters-converter', category: 'length-conversions' },
  { id: 319, name: 'Rods to Feet Converter', description: 'Convert rods/poles/perches to feet.', slug: 'rods-to-feet-converter', category: 'length-conversions' },
  // Home Improvement
  {
    id: 1,
