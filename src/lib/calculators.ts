...
export const calculators: Calculator[] = [
  ...
  },
  {
    ...
    description: 'Calculate the current worth of a future sum of money. Essential for understanding the time value of money and making informed investment decisions.',
  ...
  },
  {
    ...
    description: 'Project the future worth of a current investment. See how your money can grow over time with the power of compounding interest.',
  ...
  },
  {
    ...
    description: 'Determine the fixed periodic payment required for a loan (like a mortgage) or to reach a future savings goal with an annuity.',
  ...
  },
  {
    ...
    description: 'Calculate the present value of an infinite series of equal payments. A core concept for valuing certain types of securities.',
  ...
  },
  {
    ...
    description: 'Value a stream of payments that grows at a constant rate, either for a finite period (annuity) or indefinitely (perpetuity).',
