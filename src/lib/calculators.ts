...
export const calculators: Calculator[] = [
  ...
  { id: 392, name: 'Réaumur to Celsius Converter', description: 'Convert Réaumur to Celsius.', slug: 'reaumur-to-celsius-converter', category: 'conversions' },
  { id: 393, name: 'Celsius to Réaumur Converter', description: 'Convert Celsius to Réaumur.', slug: 'celsius-to-reaumur-converter', category: 'conversions' },
  { id: 394, name: 'Fahrenheit to Réaumur Converter', description: 'Convert Fahrenheit to Réaumur.', slug: 'fahrenheit-to-reaumur-converter', category: 'conversions' },
  { id: 395, name: 'Réaumur to Fahrenheit Converter', description: 'Convert Réaumur to Fahrenheit.', slug: 'reaumur-to-fahrenheit-converter', category: 'conversions' },
  { id: 396, name: 'Kelvin to Réaumur Converter', description: 'Convert Kelvin to Réaumur.', slug: 'kelvin-to-reaumur-converter', category: 'conversions' },
  { id: 397, name: 'Réaumur to Kelvin Converter', description: 'Convert Réaumur to Kelvin.', slug: 'reaumur-to-kelvin-converter', category: 'conversions' },
  { id: 398, name: 'Rankine to Réaumur Converter', description: 'Convert Rankine to Réaumur.', slug: 'rankine-to-reaumur-converter', category: 'conversions' },
  { id: 399, name: 'Réaumur to Rankine Converter', description: 'Convert Réaumur to Rankine.', slug: 'reaumur-to-rankine-converter', category: 'conversions' },
  // Home Improvement
  {
    id: 1,
