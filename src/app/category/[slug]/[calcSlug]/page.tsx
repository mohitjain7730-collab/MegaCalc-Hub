...
export async function generateStaticParams() {
  ...
  if (isDev) {
    // In dev, avoid loading the huge array if possible?
    // Accessing `calculators` triggers the load.
    // If we want to be truly fast, we should avoid this access.
    // We can return an empty array in dev and let dynamicParams handle it!
    return [];
  }
...
export async function generateMetadata({
  ...
  // ... rest of function using calculator ...
