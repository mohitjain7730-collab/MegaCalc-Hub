...
const calculatorComponents: { [key: string]: React.ComponentType } = {
    ...
    // Length Conversions
    'meters-to-feet-converter': dynamic(() => import('@/components/calculators/length-conversions/meters-to-feet-converter')),
    'feet-to-meters-converter': dynamic(() => import('@/components/calculators/length-conversions/feet-to-meters-converter')),
    'centimeters-to-inches-converter': dynamic(() => import('@/components/calculators/length-conversions/centimeters-to-inches-converter')),
    'inches-to-centimeters-converter': dynamic(() => import('@/components/calculators/length-conversions/inches-to-centimeters-converter')),
    'millimeters-to-inches-converter': dynamic(() => import('@/components/calculators/length-conversions/millimeters-to-inches-converter')),
    'inches-to-millimeters-converter': dynamic(() => import('@/components/calculators/length-conversions/inches-to-millimeters-converter')),
    'meters-to-yards-converter': dynamic(() => import('@/components/calculators/length-conversions/meters-to-yards-converter')),
    'yards-to-meters-converter': dynamic(() => import('@/components/calculators/length-conversions/yards-to-meters-converter')),
    'miles-to-kilometers-converter': dynamic(() => import('@/components/calculators/length-conversions/miles-to-kilometers-converter')),
    'kilometers-to-miles-converter': dynamic(() => import('@/components/calculators/length-conversions/kilometers-to-miles-converter')),
    'nautical-miles-to-kilometers-converter': dynamic(() => import('@/components/calculators/length-conversions/nautical-miles-to-kilometers-converter')),
    'kilometers-to-nautical-miles-converter': dynamic(() => import('@/components/calculators/length-conversions/kilometers-to-nautical-miles-converter')),
    'micrometers-to-millimeters-converter': dynamic(() => import('@/components/calculators/length-conversions/micrometers-to-millimeters-converter')),
    'nanometers-to-meters-converter': dynamic(() => import('@/components/calculators/length-conversions/nanometers-to-meters-converter')),
    'light-years-to-kilometers-converter': dynamic(() => import('@/components/calculators/length-conversions/light-years-to-kilometers-converter')),
    'parsecs-to-light-years-converter': dynamic(() => import('@/components/calculators/length-conversions/parsecs-to-light-years-converter')),
    'astronomical-units-to-kilometers-converter': dynamic(() => import('@/components/calculators/length-conversions/astronomical-units-to-kilometers-converter')),
    'fathoms-to-meters-converter': dynamic(() => import('@/components/calculators/length-conversions/fathoms-to-meters-converter')),
    'chains-to-meters-converter': dynamic(() => import('@/components/calculators/length-conversions/chains-to-meters-converter')),
    'rods-to-feet-converter': dynamic(() => import('@/components/calculators/length-conversions/rods-to-feet-converter')),
  };
