...
export default function StocksSecuritiesPage() {
  return (
      ...
      <div className="w-full max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="mt-2 text-lg text-muted-foreground max-w-3xl">
            Learn about stock investing, market analysis, and building a diversified portfolio.
          </p>
        </div>
        ...
        <Card className="w-full text-center shadow-md">
          <CardHeader>
            ...
            <CardDescription className="text-base mt-2">
              Content for Stocks & Securities is coming soon. Check back later!
            </CardDescription>
          </CardHeader>
        </Card>
      </div>
