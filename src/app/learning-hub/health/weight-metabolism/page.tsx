...
export const metadata: Metadata = {
  title: 'Weight & Metabolism - Health Learning Hub',
  description: 'Understand weight management, metabolic health, and body composition.',
  alternates: {
    canonical: '/learning-hub/health/weight-metabolism',
  },
};
      ...
      <div className="w-full max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="mt-2 text-lg text-muted-foreground max-w-3xl">
            Understand weight management, metabolic health, and body composition.
          </p>
        </div>
        ...
        <Card className="w-full text-center shadow-md">
          <CardHeader>
            ...
            <CardDescription className="text-base mt-2">
              Content for Weight & Metabolism is coming soon. Check back later!
            </CardDescription>
          </CardHeader>
        </Card>
      </div>
