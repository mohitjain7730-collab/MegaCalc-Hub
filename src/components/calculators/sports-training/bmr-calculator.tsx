            ...
            <AccordionContent className="text-muted-foreground space-y-2">
              <p>For more detailed information on BMR and its role in health, consult these authoritative sources:</p>
               <ul className="list-disc list-inside space-y-1 pl-4">
                  ...
                  <li><a href="https://www.gallagher.com/us/News-and-Insights/Well-Being-and-Engagement/Well-being-Articles/2016/Calculating-Your-Basal-Metabolic-Rate" target="_blank" rel="noopener noreferrer" className="text-primary underline">National Institutes of Health – Nutrition & Metabolism</a></li>
              </ul>
            </AccordionContent>
        </AccordionItem>
      </Accordion>
