    ...
    '@graph': [
        {
            ...
            itemListElement: [
                ...
                { '@type': 'ListItem', position: 3, name: 'Pet Simulator X Mastery Calculator', item: baseUrl },
            ],
        },
        {
...
export default function RobloxPSXMasteryCalc() {
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500 max-w-4xl mx-auto">
            <Script id="psx-mastery-schema" type="application/ld+json" strategy="afterInteractive" dangerouslySetInnerHTML={{ __html: JSON.stringify(schemaMarkup) }} />
