...
const calculateProbabilities = (values: FormValues): ResultPayload => {
    ...
    const k = values.targetPets; // Target successes
    ...
    // For specific target k, this is complex cumulatively, keeping it simple for UI:
    // If k=1, use the exact formula above. If k > 1, use approximation or just show Expected Value context.
    // We will show "At least 1" specifically as the main metric.
