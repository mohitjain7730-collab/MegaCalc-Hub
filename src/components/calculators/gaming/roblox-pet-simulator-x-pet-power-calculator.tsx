...
const baseUrl = 'https://mycalculating.com/category/gaming/roblox-pet-simulator-x-pet-power-calculator';
    ...
    '@graph': [
        {
            ...
            itemListElement: [
                ...
                { '@type': 'ListItem', position: 3, name: 'Pet Simulator X Power Calculator', item: baseUrl },
            ],
        },
        {
...
export default function RobloxPetSimPowerCalc() {
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            <Script id="psx-power-schema" type="application/ld+json" strategy="afterInteractive" dangerouslySetInnerHTML={{ __html: JSON.stringify(schemaMarkup) }} />
