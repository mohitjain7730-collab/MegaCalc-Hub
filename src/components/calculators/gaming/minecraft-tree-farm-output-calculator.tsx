...
export default function MinecraftTreeFarmOutputCalculator() {
  ...
  return (
    <div className="space-y-8">
      <Script id="minecraft-tree-farm-output-calculator-schema" type="application/ld+json" strategy="afterInteractive" dangerouslySetInnerHTML={{ __html: JSON.stringify(schemaMarkup) }} />
