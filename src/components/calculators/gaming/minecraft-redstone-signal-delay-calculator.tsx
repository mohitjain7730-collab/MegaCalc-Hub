...
export default function MinecraftRedstoneSignalDelayCalculator() {
  ...
  return (
    <div className="space-y-8">
      <Script id="minecraft-redstone-signal-delay-calculator-schema" type="application/ld+json" strategy="afterInteractive" dangerouslySetInnerHTML={{ __html: JSON.stringify(schemaMarkup) }} />
