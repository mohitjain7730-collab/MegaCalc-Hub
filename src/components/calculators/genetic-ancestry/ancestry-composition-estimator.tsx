    ...
    <Card className="w-full text-center shadow-md mt-8">
        ...
        <CardContent className="p-8 pt-0">
            <p className="text-lg text-muted-foreground">
                This calculator is under construction. It will provide a simplified, illustrative estimation of ancestry composition for educational and entertainment purposes.
            </p>
            <p className="mt-4 text-sm text-destructive">
                Note: This tool is not a substitute for professional DNA testing or genealogical research.
            </p>
        </CardContent>
    </Card>
  );
