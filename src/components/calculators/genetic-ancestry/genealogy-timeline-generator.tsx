    ...
    <Card className="w-full text-center shadow-md mt-8">
        ...
        <CardContent className="p-8 pt-0">
            <p className="text-lg text-muted-foreground">
                This calculator is under construction. It will allow you to generate a visual timeline of your ancestors based on birth and death dates.
            </p>
             <p className="mt-4 text-sm text-destructive">
                Note: This tool is for personal organizational and visualization purposes.
            </p>
        </CardContent>
    </Card>
  );
