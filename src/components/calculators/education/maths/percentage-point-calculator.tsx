...
import { calculatePercentagePoint } from '@/lib/percentage';
    ...
    return (
        <div className="space-y-8">
            ...
            <Card>
                ...
                <CardContent className="space-y-4">
                    <div>
                        ...
                        <p className="text-muted-foreground">The two percentage values to compare.</p>
                    </div>
                </CardContent>
            </Card>
            ...
            <Card>
                ...
                <CardContent>
                    <p>Difference = Final Percentage - Initial Percentage</p>
                </CardContent>
            </Card>
                ...
                <CardContent>
                    <Accordion type="single" collapsible className="w-full">
                        <AccordionItem value="item-1">
                            <AccordionTrigger>Is this the same as percent change?</AccordionTrigger>
                            <AccordionContent>
                                <p>No. Percentage point difference is simple subtraction (e.g., 12% - 10% = 2 points). Percent change is relative (e.g., 10% to 12% is a 20% increase).</p>
                            </AccordionContent>
                        </AccordionItem>
                    </Accordion>
                </CardContent>
