...
const dateSchema = z.object({
    year: z.number().int().max(9999, 'Year is too large'),
...
const formSchema = z.object({
    ...
    if (startDate && endDate && endDate < startDate) {
        // This validation is for user feedback, the calculation will swap them.
        // You could add a specific error message here if strict start < end is required.
    }
});
                ...
                <TabsContent value="dropdown">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-4">
                        <div>
                            ...
                            <FormMessage>{form.formState.errors.dropdown?.start?.message}</FormMessage>
                        </div>
                         <div>
