    ...
    <div className="space-y-8">
      ...
      <div className="space-y-6">
        ...
        <div className="prose dark:prose-invert max-w-none">
          ...
          <ul>
            <li><strong>Dropdown Selection:</strong><br/>Choose day, month, and year separately (for precise control).<br/>Works with years up to 5000 and down to 0.</li>
            <li><strong>Direct Input:</strong><br/>Enter start and end dates directly using the date picker.<br/>Ideal for quick calculations.</li>
          </ul>
          <h3>🧰 Applications of the Date Difference Calculator</h3>
          <ul>
            <li><strong>Age Calculation:</strong><br/>Find your exact age in years, months, and days.</li>
            <li><strong>Project Duration:</strong><br/>Calculate the time span between project start and completion dates.</li>
            <li><strong>Event Planning:</strong><br/>Count the number of days until an event or deadline.</li>
            <li><strong>Historical Analysis:</strong><br/>Measure how much time passed between two historical events.</li>
            <li><strong>Loan / Investment Tenure:</strong><br/>Check the exact period between investment and maturity dates.</li>
          </ul>
          ...
          <ul>
            <li><strong>Days Difference:</strong><br/>It finds the total number of days between two timestamps.</li>
            <li><strong>Months and Years:</strong><br/>Starts with year difference: endYear - startYear<br/>Adjusts months: endMonth - startMonth<br/>Adjusts days: endDay - startDay<br/>If negative, months/days are carried over accordingly.</li>
          </ul>
