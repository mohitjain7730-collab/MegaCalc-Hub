    ...
    <div className="space-y-8">
      ...
      >
        ...
        <div className="space-y-2">
          <p><Link href="/date-difference-calculator" className="text-primary underline">Date Difference Calculator</Link></p>
          <p><Link href="/day-of-the-week-calculator" className="text-primary underline">Day of the Week Calculator</Link></p>
          <p><Link href="/working-days-business-days-calculator" className="text-primary underline">Working Days / Business Days Calculator</Link></p>
        </div>
      </section>
    </div>
  );
