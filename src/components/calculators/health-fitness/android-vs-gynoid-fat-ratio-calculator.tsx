          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 border rounded">
              <h4 className="font-semibold mb-1">
                <Link href="/waist-to-hip-ratio-calculator" className="text-primary hover:underline">
            ...
            <div className="p-4 border rounded">
              <h4 className="font-semibold mb-1">
                <Link href="/waist-to-height-ratio-calculator" className="text-primary hover:underline">
