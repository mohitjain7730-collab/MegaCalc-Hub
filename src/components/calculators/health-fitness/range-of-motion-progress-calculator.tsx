...
const relatedCalculators = [
  { title: 'Injury Recovery Timeline Calculator', href: '/injury-recovery-timeline-calculator', description: 'Align ROM gains with expected tissue healing windows.' },
  { title: 'Physical Therapy Session Intensity Calculator', href: '/physical-therapy-session-intensity-calculator', description: 'Match session load with your current recovery stage.' },
  { title: 'Strength to Weight Ratio Calculator', href: '/strength-to-weight-ratio-calculator', description: 'Track strength improvements that support functional ROM.' },
  { title: 'Training Volume Calculator', href: '/training-volume-calculator', description: 'Balance total workload to avoid overtraining stiff joints.' },
];
