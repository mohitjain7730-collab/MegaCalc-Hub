      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-4 border rounded">
              <h4 className="font-semibold mb-1">
                <Link href="/standing-vs-sitting-calorie-burn-calculator" className="text-primary hover:underline">
            ...
            <div className="p-4 border rounded">
              <h4 className="font-semibold mb-1">
                <Link href="/mets-calories-burned-calculator" className="text-primary hover:underline">
            ...
            <div className="p-4 border rounded">
              <h4 className="font-semibold mb-1">
                <Link href="/bmr-calculator" className="text-primary hover:underline">
                  BMR Calculator
                </Link>
              </h4>
