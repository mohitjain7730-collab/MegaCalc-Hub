...
const relatedCalculators = [
  { title: 'Injury Recovery Timeline Calculator', href: '/injury-recovery-timeline-calculator', description: 'Estimate overall healing windows before advancing intensity.' },
  { title: 'Range of Motion Progress Calculator', href: '/range-of-motion-progress-calculator', description: 'Track mobility improvements to justify greater loading.' },
  { title: 'Strength to Weight Ratio Calculator', href: '/strength-to-weight-ratio-calculator', description: 'Measure readiness for higher-level functional drills.' },
  { title: 'Training Volume Calculator', href: '/training-volume-calculator', description: 'Balance workload across therapy, sport practice, and strength training.' },
];
