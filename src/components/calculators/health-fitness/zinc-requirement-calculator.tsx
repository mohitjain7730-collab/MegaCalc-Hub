    ...
    <Card className="w-full text-center shadow-md mt-8">
        ...
        <CardContent className="p-8 pt-0">
            <p className="text-lg text-muted-foreground">
                This calculator is under construction. It would use RDA values based on age and sex, which are readily available, but to be useful it would also need a food intake component similar to other nutritional calculators.
            </p>
        </CardContent>
    </Card>
  );
