  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-2">
        ...
        <p><Link className="text-primary underline" href="/electrolyte-replacement-calculator">Low-Sodium Diet Planner Calculator</Link></p>
        <p><Link className="text-primary underline" href="/protein-intake-calculator">Vegan Protein Requirement Calculator</Link></p>
      </div>
    </div>
  );
}
