    ...
    <Card className="w-full text-center shadow-md mt-8">
        ...
        <CardContent className="p-8 pt-0">
            <p className="text-lg text-muted-foreground">
                This calculator is under construction. It requires access to a comprehensive database of ORAC (Oxygen Radical Absorbance Capacity) values for various foods, which can be inconsistent and are not always publicly available in a standardized format.
            </p>
        </CardContent>
    </Card>
  );
