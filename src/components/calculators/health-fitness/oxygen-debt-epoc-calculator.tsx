      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 border rounded"><h4 className="font-semibold mb-1"><Link href="/post-exercise-oxygen-consumption-calculator" className="text-primary hover:underline">Post-Exercise Oxygen Consumption</Link></h4><p className="text-sm text-muted-foreground">Detailed analysis of post-exercise metabolic effects.</p></div>
            <div className="p-4 border rounded"><h4 className="font-semibold mb-1"><Link href="/anaerobic-capacity-calculator" className="text-primary hover:underline">Anaerobic Capacity</Link></h4><p className="text-sm text-muted-foreground">Assess power output for high-intensity efforts.</p></div>
            ...
            <div className="p-4 border rounded"><h4 className="font-semibold mb-1"><Link href="/lactate-accumulation-rate-calculator" className="text-primary hover:underline">Lactate Accumulation</Link></h4><p className="text-sm text-muted-foreground">Understand metabolic stress during exercise.</p></div>
          </div>
        </CardContent>
      </Card>
