      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-4 border rounded"><h4 className="font-semibold mb-1"><Link href="/category/health-fitness/carbohydrate-intake-calculator" className="text-primary hover:underline">Fiber Intake Calculator</Link></h4><p className="text-sm text-muted-foreground">Confirm adequate fiber from vegetables and fruits.</p></div>
            <div className="p-4 border rounded"><h4 className="font-semibold mb-1"><Link href="/category/health-fitness/electrolyte-replacement-calculator" className="text-primary hover:underline">Micronutrient Tracker</Link></h4><p className="text-sm text-muted-foreground">Ensure Paleo choices cover vitamin and mineral targets.</p></div>
          </div>
        </CardContent>
      </Card>
