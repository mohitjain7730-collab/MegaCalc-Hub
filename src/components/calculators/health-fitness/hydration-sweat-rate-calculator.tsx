    ...
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      ...
      >
        ...
        <div className="space-y-2">
          <p><Link href="/hydration-needs-calculator" className="text-primary underline">Hydration Needs Calculator</Link></p>
          <p><Link href="/electrolyte-replacement-calculator" className="text-primary underline">Electrolyte Replacement Calculator</Link></p>
          <p><Link href="/electrolyte-replacement-calculator" className="text-primary underline">Core Body Temperature Rise Calculator</Link></p>
