    ...
    <div className="space-y-8">
      ...
      {result && (
       ...
       <Accordion type="single" collapsible className="w-full">
        ...
        <AccordionItem value="macro-guide">
          <AccordionTrigger>Complete Guide on Macro Ratios</AccordionTrigger>
          <AccordionContent className="text-muted-foreground space-y-4 prose prose-sm dark:prose-invert max-w-none">
            <h3>Macro Ratio Calculator — Find the Best Carb / Protein / Fat Split for Your Goals</h3>
