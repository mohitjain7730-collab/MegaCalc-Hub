    ...
    <Card className="w-full text-center shadow-md mt-8">
        ...
        <CardContent className="p-8 pt-0">
            <p className="text-lg text-muted-foreground">
                This calculator is under construction. Estimating Vitamin D synthesis accurately is complex, requiring geographical location (UV index), time of day, skin type, and amount of skin exposed, which involves complex modeling.
            </p>
        </CardContent>
    </Card>
  );
