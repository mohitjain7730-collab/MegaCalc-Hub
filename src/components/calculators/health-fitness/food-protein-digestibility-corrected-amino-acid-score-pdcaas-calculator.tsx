    ...
    <Card className="w-full text-center shadow-md mt-8">
        ...
        <CardContent className="p-8 pt-0">
            <p className="text-lg text-muted-foreground">
                This calculator is under construction. It requires a detailed database of amino acid profiles and digestibility scores for various protein sources, which is highly specialized scientific data.
            </p>
        </CardContent>
    </Card>
  );
