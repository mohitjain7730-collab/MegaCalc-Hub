...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Not necessarily. 70â€“90Â°C (158â€“194Â°F) is a common effective range. Higher temps require shorter sessions and better hydration to avoid overheating.',
  },
  {
    question: 'How much should I hydrate before sauna?',
    answer:
      'Aim for 300â€“500 ml (10â€“17 oz) of water 15â€“30 minutes before entering. Avoid overhydration right before to prevent discomfort.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yes, but infrared operates at lower ambient temps (45â€“60Â°C). Adjust temperature input to reflect the effective heat you feel.',
  },
  {
    question: 'How often should I sauna?',
    answer:
      'Most research suggests 2â€“4 sessions per week for general benefits. Daily use is fine if you tolerate it and maintain hydration.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yesâ€”heat therapy can reduce soreness and improve circulation. Pair with proper sleep and nutrition for best results.',
  },
  {
    question: 'Should I eat before sauna?',
    answer:
      'Light meals 1â€“2 hours before are fine. Avoid heavy meals right before to prevent digestive discomfort during heat exposure.',
  },
  {
...
const baseUrl = 'https://mycalculating.com/health-fitness/sauna-session-detox-score-calculator';
...
const calculateResult = (values: FormValues): ResultPayload => {
  ...
  const recommendations = [
    ...
    'Leaving space for a few minutes of coolâ€‘down between rounds can give your body a chance to settle and check in.',
  ];
  if (status === 'moderate') {
    recommendations.push('You might experiment with 2â€“4 sessions per week if that fits your life and feels supportive, without forcing it.');
  }
  ...
  const plan = [
    ...
    { label: 'Next 2 Weeks', detail: 'If it feels right, gently adjust one variableâ€”like a slightly different duration or extra waterâ€”and see how your body responds.' },
    ...
    <div className="space-y-8">
            ...
            <form onSubmit={form.handleSubmit((values) => setResult(calculateResult(values)))} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Sauna temperature (Â°C)</FormLabel>
                      <FormControl>
          ...
          <CardContent className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-4 border rounded">
                ...
                <p className="text-xs text-muted-foreground">A 0â€“100 snapshot of how this sauna routine fits this simple model.</p>
              </div>
              <div className="p-4 border rounded">
                ...
                <p className="text-xs text-muted-foreground">A rough blend of heat exposure and preâ€‘session hydration.</p>
              </div>
              <div className="p-4 border rounded">
      ...
      <Card>
        ...
        <CardContent className="text-sm text-muted-foreground space-y-2">
          ...
          <p><strong>Sweat efficiency</strong> = (heatLoad + durationScore) Ã— 0.8 + hydrationScore Ã— 0.2.</p>
          ...
          {result ? (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="p-4 border rounded">
                ...
                <p className="text-xl font-semibold text-primary">
                  {((form.getValues().temperatureC ?? 0) - 50).toFixed(0)}Â°C above baseline
                </p>
                <p className="text-xs text-muted-foreground">Relative to 50Â°C minimum</p>
              </div>
              <div className="p-4 border rounded">
