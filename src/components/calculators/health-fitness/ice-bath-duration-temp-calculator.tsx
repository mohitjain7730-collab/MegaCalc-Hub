  ...
  return (
    <div className="space-y-8">
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 border rounded"><h4 className="font-semibold mb-1"><a href="/category/health-fitness/target-heart-rate-calculator" className="text-primary hover:underline">Recovery Heart Rate</a></h4><p className="text-sm text-muted-foreground">Track autonomic recovery after training.</p></div>
