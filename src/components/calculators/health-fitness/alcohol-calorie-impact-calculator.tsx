				...
				<CardContent>
					<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
						<div className="p-4 border rounded-lg">
							<h4 className="font-semibold mb-1"><a href="/daily-calorie-needs-calculator" className="text-primary hover:underline">Daily Calorie Needs</a></h4>
							<p className="text-sm text-muted-foreground">Estimate your TDEE to plan intake.</p>
						</div>
						<div className="p-4 border rounded-lg">
							<h4 className="font-semibold mb-1"><a href="/protein-intake-calculator" className="text-primary hover:underline">Protein Intake</a></h4>
