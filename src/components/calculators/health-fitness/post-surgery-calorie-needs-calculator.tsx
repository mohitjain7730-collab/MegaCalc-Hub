...
const relatedCalculators = [
  { title: 'Basal Metabolic Rate (BMR) Calculator', href: '/bmr-calculator', description: 'Understand your baseline before surgery adjustments.' },
  { title: 'Protein Intake Calculator', href: '/protein-intake-calculator', description: 'Dial in daily grams to support wound healing.' },
  { title: 'Hydration Needs Calculator', href: '/hydration-needs-calculator', description: 'Set fluid targets that aid recovery and medication absorption.' },
  { title: 'Body Composition Tracker', href: '/body-fat-percentage-calculator', description: 'Monitor long-term shifts after returning to activity.' },
];
