...
const schemaMarkup = {
  ...
  '@graph': [
    ...
    {
      '@type': 'Article',
      headline: 'Daily Stress Tendency Check-In',
    ...
    {
      '@type': 'HowTo',
      name: 'How to Use Daily Stress Tendency Check-In Calculator',
      description: 'Step-by-step guide to assess daily stress tendency',
