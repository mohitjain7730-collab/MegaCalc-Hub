       ...
       <Accordion type="single" collapsible className="w-full">
         <AccordionItem value="how-it-works">
            ...
            <AccordionContent className="text-muted-foreground">
                <p>This calculator estimates your daily calorie needs for weight loss by first calculating your Total Daily Energy Expenditure (TDEE) and then creating a deficit based on your goal. It uses the Mifflin-St Jeor equation for BMR, which is a common standard.</p>
            </AccordionContent>
        </AccordionItem>
      </Accordion>
    </div>
