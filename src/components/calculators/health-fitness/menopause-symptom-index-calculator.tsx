...
const schemaMarkup = {
  ...
  '@graph': [
    ...
    {
      '@type': 'Article',
      headline: 'Menopause Symptom Index Calculator',
    ...
    {
      '@type': 'HowTo',
      name: 'How to Use Menopause Symptom Index Calculator',
      description: 'Step-by-step guide to assess menopause symptoms',
