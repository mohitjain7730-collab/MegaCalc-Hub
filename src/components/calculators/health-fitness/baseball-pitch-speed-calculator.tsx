  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-2">
        ...
        <p><Link className="text-primary underline" href="/running-pace-calculator">Tennis Serve Speed Calculator</Link></p>
        <p><Link className="text-primary underline" href="/strength-to-weight-ratio-calculator">Strength-to-Weight Ratio</Link></p>
        <p><Link className="text-primary underline" href="/running-pace-calculator">Basketball Shooting Percentage Calculator</Link></p>
      </div>
    </div>
  );
}
