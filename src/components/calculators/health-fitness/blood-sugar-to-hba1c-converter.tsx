    ...
    <Card>
      ...
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Link href="/glycemic-load-calculator" className="text-primary underline hover:text-primary/80">
            Glycemic Load Calculator
          </Link>
          <Link href="/meal-glycemic-load-calculator" className="text-primary underline hover:text-primary/80">
            Meal Glycemic Load Calculator
          </Link>
          <Link href="/bmi-calculator" className="text-primary underline hover:text-primary/80">
