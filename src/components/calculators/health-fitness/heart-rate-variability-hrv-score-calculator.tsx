  ...
  return (
    <div className="space-y-8">
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 border rounded"><h4 className="font-semibold mb-1"><Link href="/target-heart-rate-calculator" className="text-primary hover:underline">Recovery Heart Rhythm Check-In</Link></h4><p className="text-sm text-muted-foreground">Reflect on how quickly your pulse settles after effort.</p></div>
            <div className="p-4 border rounded"><h4 className="font-semibold mb-1"><Link href="/daily-activity-points-calculator" className="text-primary hover:underline">Daily Stress Tendency Check-In</Link></h4><p className="text-sm text-muted-foreground">Gently score how overloaded or steady your day feels.</p></div>
            <div className="p-4 border rounded"><h4 className="font-semibold mb-1"><Link href="/meditation-breathing-rate-calculator" className="text-primary hover:underline">Meditation Breathing Rhythm Helper</Link></h4><p className="text-sm text-muted-foreground">Explore a comfortable breathing pace for calmer sessions.</p></div>
            <div className="p-4 border rounded"><h4 className="font-semibold mb-1"><Link href="/cortisol-stress-response-estimator" className="text-primary hover:underline">Daily Stress & Recovery Balance Score</Link></h4><p className="text-sm text-muted-foreground">Look at how your sleep, movement, and downtime stack together.</p></div>
          </div>
        </CardContent>
      </Card>
