...
const relatedCalculators = [
  { title: 'Hydration Sweat Rate Calculator', href: '/hydration-needs-calculator', description: 'Estimate sweat losses during workouts to plan fluid replacement.' },
  { title: 'Hydration Needs Calculator', href: '/hydration-needs-calculator', description: 'Determine daily water intake targets for optimal thermoregulation.' },
  { title: 'Exercise Calorie Burn Calculator', href: '/mets-calories-burned-calculator', description: 'Understand caloric cost of sessions as intensity changes.' },
  { title: 'Ice Bath Duration & Temperature Calculator', href: '/ice-bath-duration-temp-calculator', description: 'Calculate optimal cold exposure protocols for recovery and temperature regulation.' },
];
