  ...
  return (
    <div className="space-y-8">
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 border rounded"><h4 className="font-semibold mb-1"><Link href="/health-fitness/one-rep-max-strength-calculator" className="text-primary hover:underline">One‑Rep Max</Link></h4><p className="text-sm text-muted-foreground">Strength baseline.</p></div>
            ...
            <div className="p-4 border rounded"><h4 className="font-semibold mb-1"><Link href="/health-fitness/critical-power-calculator" className="text-primary hover:underline">Critical Power</Link></h4><p className="text-sm text-muted-foreground">Power profiles.</p></div>
            <div className="p-4 border rounded"><h4 className="font-semibold mb-1"><Link href="/health-fitness/training-volume-calculator" className="text-primary hover:underline">Training Volume</Link></h4><p className="text-sm text-muted-foreground">Plan workload.</p></div>
          </div>
        </CardContent>
      </Card>
