      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-4 border rounded">
              <h4 className="font-semibold mb-1"><Link href="/carbohydrate-intake-calculator" className="text-primary hover:underline">Carbohydrate Intake</Link></h4>
              <p className="text-sm text-muted-foreground">Daily carb targets by activity.</p>
            </div>
            <div className="p-4 border rounded">
              <h4 className="font-semibold mb-1"><Link href="/training-volume-calculator" className="text-primary hover:underline">Training Volume</Link></h4>
