...
import { RefreshCw, Calculator, Info, FileText, Globe, TrendingUp, Target, FunctionSquare, CheckCircle2, AlertCircle, Shield } from 'lucide-react';
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <Card className="h-full">
          <CardHeader>
            ...
            <CardDescription>Currency exchange advantages</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex items-start gap-3 p-3 bg-primary/5 rounded-lg border border-primary/10">
              <CheckCircle2 className="h-5 w-5 text-primary mt-0.5 shrink-0" />
              <span className="text-sm font-medium">Instant conversion between any currency pair</span>
            </div>
            <div className="flex items-start gap-3 p-3 bg-primary/5 rounded-lg border border-primary/10">
              <CheckCircle2 className="h-5 w-5 text-primary mt-0.5 shrink-0" />
              <span className="text-sm font-medium">Supports international trade and travel planning</span>
            </div>
            <div className="flex items-start gap-3 p-3 bg-primary/5 rounded-lg border border-primary/10">
              <CheckCircle2 className="h-5 w-5 text-primary mt-0.5 shrink-0" />
              <span className="text-sm font-medium">Compare rates across different providers</span>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="h-full border-red-100 bg-red-50/10 dark:border-red-900/20 dark:bg-red-900/5">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-start gap-3 p-3 bg-red-50 dark:bg-red-900/10 rounded-lg border border-red-100 dark:border-red-900/20">
              ...
              <span className="text-sm font-medium text-red-800 dark:text-red-300">Rates change constantly (volatility risk)</span>
            </div>
            <div className="flex items-start gap-3 p-3 bg-red-50 dark:bg-red-900/10 rounded-lg border border-red-100 dark:border-red-900/20">
              <AlertCircle className="h-5 w-5 text-red-600 dark:text-red-400 mt-0.5 shrink-0" />
              <span className="text-sm font-medium text-red-800 dark:text-red-300">Bid-ask spreads add transaction costs</span>
            </div>
            <div className="flex items-start gap-3 p-3 bg-red-50 dark:bg-red-900/10 rounded-lg border border-red-100 dark:border-red-900/20">
              <AlertCircle className="h-5 w-5 text-red-600 dark:text-red-400 mt-0.5 shrink-0" />
              <span className="text-sm font-medium text-red-800 dark:text-red-300">Verify rate source before large transactions</span>
            </div>
          </CardContent>
        </Card>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 border rounded-lg hover:bg-muted/50 transition-colors">
              <h4 className="font-semibold mb-2">
                <a href="/currency-volatility-calculator" className="text-primary hover:underline">
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>Currency exchange converts one currency to another using the spot rate.</p>
          <p>Exchange rates fluctuate based on interest rates, trade flows, and market sentiment.</p>
          <p>Transaction costs are embedded in the bid-ask spread offered by dealers.</p>
        </CardContent>
      </Card>
    </div>
  );
