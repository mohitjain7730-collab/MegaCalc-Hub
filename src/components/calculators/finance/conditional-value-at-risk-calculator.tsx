...
import { Activity, AlertCircle, Target, Info, Landmark, Calculator, DollarSign, TrendingUp, BarChart3, Shield, FunctionSquare, CheckCircle2 } from 'lucide-react';
    ...
    <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <Card className="h-full">
              <CardHeader>
                ...
                <CardDescription>Tail risk profile opportunities</CardDescription>
              </CardHeader>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-4 bg-muted/50 rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">VaR threshold for tail risk calculation.</p>
            </div>
            <div className="p-4 bg-muted/50 rounded-lg">
              <h4 className="font-semibold mb-2 flex items-center gap-2">
              ...
              <p className="text-sm text-muted-foreground">Period over which tail risk is measured.</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground mt-2">
            Expected Shortfall is the average of losses exceeding the VaR threshold, capturing the magnitude of tail risk.
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <Link href="/sortino-ratio-calculator" className="group">
              <Card className="group-hover:shadow-md transition-shadow">
                <CardContent className="p-4 text-center">
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>Conditional VaR (CVaR) measures the average loss beyond the VaR threshold, capturing tail risk severity.</p>
          <p>It is the regulatory standard under Basel III, providing a coherent measure for capital allocation.</p>
          <p>Use CVaR alongside VaR for comprehensive risk management and extreme loss scenario planning.</p>
        </CardContent>
      </Card>
    </div>
  );
