    ...
    <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <Card className="h-full">
              <CardHeader>
                ...
                <CardDescription>Options valuation opportunities</CardDescription>
              </CardHeader>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="p-4 bg-muted/50 rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">Annualized standard deviation of stock returns (historical or implied).</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground mt-2">
            The Black-Scholes formula prices European options using the cumulative normal distribution to estimate probability of finishing in-the-money.
          </p>
        </CardContent>
      </Card>
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>The Black-Scholes Calculator prices European call and put options using the Nobel Prize-winning formula.</p>
          <p>It considers stock price, strike, time, risk-free rate, and volatility to derive theoretical fair values.</p>
          <p>Use this tool for options trading, risk management, and understanding implied volatility.</p>
        </CardContent>
      </Card>
    </div>
  );
