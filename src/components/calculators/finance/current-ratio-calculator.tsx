    ...
    <div className="space-y-8">
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>The Current Ratio Calculator measures a company's ability to pay short-term obligations with its current assets.</p>
          <p>It is a fundamental metric for assessing liquidity and working capital health.</p>
          <p>Use this tool to track liquidity trends and ensure the company maintains sufficient working capital.</p>
        </CardContent>
      </Card>
    </div>
  );
