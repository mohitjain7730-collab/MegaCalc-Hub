...
import { Calculator, DollarSign, TrendingUp, Info, AlertCircle, Target, Calendar, BarChart, CreditCard, Shield, FunctionSquare, CheckCircle2 } from 'lucide-react';
    ...
    <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <Card className="h-full">
                  <CardHeader>
                    ...
                    <CardDescription>Optimizing your annuity plan</CardDescription>
                  </CardHeader>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <p className="font-medium text-sm mb-2 text-center">Payment (from PV)</p>
              ...
              <div>
                <p className="font-medium text-sm mb-2 text-center">Payment (from FV)</p>
                <div className="p-4 bg-muted rounded-lg overflow-x-auto">
                  <p className="font-mono text-sm text-center">
                    PMT = FV × [ r / ((1 + r)^n - 1) ]
                  </p>
            ...
            <div className="text-sm text-muted-foreground grid grid-cols-1 md:grid-cols-2 gap-4">
              <ul className="space-y-1">
                <li><span className="font-semibold">PMT</span> = Regular Payment Amount</li>
              ...
              <ul className="space-y-1">
                ...
                <li><span className="font-semibold">n</span> = Total Number of Payments (Periods)</li>
              </ul>
            </div>
          </CardContent>
        </Card>
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>The Annuity Payment Calculator determines the regular payment required to pay off a loan or reach a savings goal over a specific period.</p>
          <p>It handles both Ordinary Annuities (payments at end of period) and Annuities Due (payments at beginning), making it versatile for mortgages, leases, and retirement planning.</p>
          <p>Use this tool to compare loan terms, plan retirement withdrawals, or set savings targets with confidence.</p>
        </CardContent>
      </Card>
    </div>
  );
