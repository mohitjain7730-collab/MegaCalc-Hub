...
import { Activity, TrendingUp, AlertCircle, Info, Landmark, Calculator, DollarSign, LineChart, FunctionSquare, CheckCircle2, TrendingDown, ArrowUpRight } from 'lucide-react';
