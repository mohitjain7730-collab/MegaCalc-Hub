      ...
      {result !== null && (
        <Card className="mt-8">
          ...
          <CardContent>
            ...
            <CardDescription className='mt-4 text-center'>This means investors are willing to pay ${result.toFixed(2)} for every $1 of the company's earnings.</CardDescription>
          </CardContent>
        </Card>
      )}
      <Accordion type="single" collapsible className="w-full">
        <AccordionItem value="how-it-works">
          ...
          <AccordionContent className="text-muted-foreground space-y-2">
            <p>The Price-to-Earnings (P/E) ratio is a valuation metric that compares a company's current share price to its per-share earnings. A high P/E could mean that a stock's price is high relative to earnings and possibly overvalued. Conversely, a low P/E might indicate that the current stock price is low relative to earnings and possibly undervalued.</p>
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value="further-reading">
            <AccordionTrigger>Further Reading</AccordionTrigger>
            <AccordionContent className="text-muted-foreground">
                 <a href="https://www.sec.gov/oiea/investor-alerts-and-bulletins/ib_pe-ratio" target="_blank" rel="noopener noreferrer" className="text-primary underline">U.S. SEC – Key Metrics: P/E</a>
            </AccordionContent>
        </AccordionItem>
      </Accordion>
    </div>
