...
import { Activity, TrendingUp, AlertCircle, Info, Landmark, Calculator, DollarSign, CheckCircle2, Percent, FunctionSquare, ArrowUpRight, ShieldCheck } from 'lucide-react';
