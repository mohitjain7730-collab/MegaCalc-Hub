      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 border rounded-lg hover:bg-muted/50 transition-colors"><h4 className="font-semibold mb-2"><a href="/contribution-margin-calculator" className="text-primary hover:underline">Contribution Margin</a></h4><p className="text-sm text-muted-foreground">Unit margin.</p></div>
            <div className="p-4 border rounded-lg hover:bg-muted/50 transition-colors"><h4 className="font-semibold mb-2"><a href="/break-even-analysis-calculator" className="text-primary hover:underline">Break-even Analysis</a></h4><p className="text-sm text-muted-foreground">Fixed vs variable.</p></div>
            <div className="p-4 border rounded-lg hover:bg-muted/50 transition-colors"><h4 className="font-semibold mb-2"><a href="/gross-margin-calculator" className="text-primary hover:underline">Gross Margin</a></h4><p className="text-sm text-muted-foreground">Gross profitability.</p></div>
            <div className="p-4 border rounded-lg hover:bg-muted/50 transition-colors"><h4 className="font-semibold mb-2"><a href="/operating-leverage-calculator" className="text-primary hover:underline">Operating Leverage</a></h4><p className="text-sm text-muted-foreground">Profit sensitivity.</p></div>
          </div>
        </CardContent>
      </Card>
