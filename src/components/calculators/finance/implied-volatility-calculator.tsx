    ...
    <div className="space-y-8">
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-4">
          <div className="p-4 bg-muted rounded-lg overflow-x-auto"><p className="font-mono text-sm text-center">Find σ such that: BS(S, K, r, σ, T) = Market Price</p></div>
          <p className="text-sm text-muted-foreground">Solved numerically via bisection; IV is the volatility that makes model price equal market price.</p>
        </CardContent>
      </Card>
      ...
      <Card className="mb-6">
        ...
        <CardContent><div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-4 bg-muted/50 rounded-lg"><h4 className="font-semibold mb-2">Spot & Strike</h4><p className="text-sm text-muted-foreground">Current underlying price and option strike.</p></div>
          <div className="p-4 bg-muted/50 rounded-lg"><h4 className="font-semibold mb-2">Rate & Time</h4><p className="text-sm text-muted-foreground">Risk-free rate and time to expiry in years.</p></div>
          <div className="p-4 bg-muted/50 rounded-lg"><h4 className="font-semibold mb-2">Option Price</h4><p className="text-sm text-muted-foreground">Current market price of the option.</p></div>
        </div></CardContent>
      </Card>

      {/* Complete SEO Guide */}
      <section className="space-y-6 text-muted-foreground leading-relaxed bg-card p-6 md:p-10 rounded-lg shadow-lg">
        <h1 className="text-3xl md:text-4xl font-extrabold text-foreground mb-4">Complete Guide to Implied Volatility</h1>
        <p className="text-lg italic">Implied volatility (IV) is the market's expectation of future volatility, extracted from option prices using the Black-Scholes model.</p>
        <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">Volatility Surface</h2>
        <p>IV varies across strikes (smile/skew) and expiries (term structure). Comparing IVs reveals relative value opportunities.</p>
        <h2 className="text-2xl font-bold text-foreground pt-8">Conclusion</h2>
        <p>Understanding IV is fundamental for options trading, volatility strategies, and assessing market sentiment.</p>
      </section>
      ...
      <Card>
        ...
        <CardContent><p className="text-muted-foreground">The Implied Volatility Calculator backs out IV from option market prices. Compare IV across strikes and expiries to identify volatility trading opportunities.</p></CardContent>
      </Card>
    </div>
  );
}
