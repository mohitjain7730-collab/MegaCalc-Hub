      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: "Portfolio Variance", desc: "Calculate total risk for N assets", href: "/category/finance/portfolio-variance-calculator" },
              { title: "WACC Calculator", desc: "Corporate cost of capital mix", href: "/category/finance/wacc-calculator" },
              { title: "Efficient Frontier", desc: "Visualize optimal allocation curve", href: "/category/finance/efficient-frontier-visualizer" },
              { title: "Sharpe Ratio", desc: "Assess risk-adjusted efficiency", href: "/category/finance/sharpe-ratio-calculator" },
              { title: "Correlation Matrix", desc: "Full asset interaction audit", href: "/category/finance/asset-correlation-matrix-calculator" },
              { title: "Beta Adjuster", desc: "Analyze systemic risk exposure", href: "/category/finance/beta-adjusted-portfolio-return-calculator" },
            ].map((tool, i) => (
