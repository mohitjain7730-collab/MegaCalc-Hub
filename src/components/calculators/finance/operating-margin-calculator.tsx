...
import { BarChart3, TrendingUp, AlertCircle, Target, Info, Landmark, Calculator, DollarSign, Percent, Shield, TrendingDown, FunctionSquare, CheckCircle2 } from 'lucide-react';
    ...
    <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <Card className="h-full">
              <CardHeader>
                ...
                <CardDescription>Efficiency optimization opportunities</CardDescription>
              </CardHeader>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <Link href="/net-profit-margin-calculator" className="group">
              <Card className="group-hover:shadow-md transition-shadow">
                <CardContent className="p-4 text-center">
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>The Operating Margin Calculator measures the profitability of your core business operations.</p>
          <p>It helps assess how well your company manages its operating expenses relative to revenue.</p>
          <p>Use this tool to compare operational efficiency against industry benchmarks and track performance over time.</p>
        </CardContent>
      </Card>
    </div>
  );
