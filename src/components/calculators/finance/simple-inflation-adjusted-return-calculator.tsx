...
import { TrendingUp, AlertCircle, Target, Info, Landmark, Calculator, DollarSign, BarChart3, Shield, Activity, Percent, FunctionSquare, CheckCircle2, Globe } from 'lucide-react';
    ...
    <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <Card className="h-full">
              <CardHeader>
                ...
                <CardDescription>Inflation-adjusted return opportunities</CardDescription>
              </CardHeader>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 bg-muted/50 rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">The original amount invested at the start of the period.</p>
            </div>
            <div className="p-4 bg-muted/50 rounded-lg">
              <h4 className="font-semibold mb-2 flex items-center gap-2">
              ...
              <p className="text-sm text-muted-foreground">The current or ending value of the investment.</p>
            </div>
            <div className="p-4 bg-muted/50 rounded-lg">
              <h4 className="font-semibold mb-2 flex items-center gap-2">
              ...
              <p className="text-sm text-muted-foreground">The average annual rate of price increase over the period.</p>
            </div>
            <div className="p-4 bg-muted/50 rounded-lg">
              <h4 className="font-semibold mb-2 flex items-center gap-2">
              ...
              <p className="text-sm text-muted-foreground">The number of years for the investment period.</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground mt-2">
            The Fisher equation calculates true purchasing power growth by adjusting for inflation.
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Link href="/real-rate-of-return-calculator" className="group">
      ...
      <Card className="mb-6">
        <CardHeader>
          ...
          <CardDescription>
            Explore other investment and return calculators
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 border rounded-lg hover:bg-muted/50 transition-colors">
              <h4 className="font-semibold mb-2">
                <Link href="/real-rate-of-return-calculator" className="text-primary hover:underline">
                  Real Rate of Return Calculator
                </Link>
              </h4>
              <p className="text-sm text-muted-foreground">
                Calculate real returns using the Fisher equation.
              </p>
            </div>
            <div className="p-4 border rounded-lg hover:bg-muted/50 transition-colors">
              <h4 className="font-semibold mb-2">
            ...
            <div className="p-4 border rounded-lg hover:bg-muted/50 transition-colors">
              <h4 className="font-semibold mb-2">
                <Link href="/future-value-calculator" className="text-primary hover:underline">
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>Real return measures true purchasing power growth by adjusting nominal returns for inflation.</p>
          <p>Positive real returns indicate wealth creation; negative real returns mean loss of purchasing power.</p>
          <p>Use the Fisher equation for accurate calculation, especially with high inflation or long time periods.</p>
        </CardContent>
      </Card>
    </div>
  );
