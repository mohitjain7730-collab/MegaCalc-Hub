...
import { PhoneCall, AlertCircle, Target, Info, Landmark, Calculator, DollarSign, TrendingUp, Shield, BarChart3, Activity, Percent, FunctionSquare, CheckCircle2 } from 'lucide-react';
    ...
    <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <Card className="h-full">
              <CardHeader>
                ...
                <CardDescription>Callable bond opportunities</CardDescription>
              </CardHeader>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 bg-muted/50 rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">Market price of the callable bond.</p>
            </div>
            <div className="p-4 bg-muted/50 rounded-lg">
              <h4 className="font-semibold mb-2 flex items-center gap-2">
              ...
              <p className="text-sm text-muted-foreground">Price at which issuer can redeem the bond early.</p>
            </div>
            <div className="p-4 bg-muted/50 rounded-lg">
              <h4 className="font-semibold mb-2 flex items-center gap-2">
              ...
              <p className="text-sm text-muted-foreground">Time until the earliest call date.</p>
            </div>
            <div className="p-4 bg-muted/50 rounded-lg">
              <h4 className="font-semibold mb-2 flex items-center gap-2">
              ...
              <p className="text-sm text-muted-foreground">Time until the bond matures if not called.</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>Yield to Call (YTC) measures return if the bond is called early; Yield to Worst (YTW) is the minimum of YTC and YTM.</p>
          <p>Use YTW for conservative analysis of callable bonds, especially in declining rate environments.</p>
          <p>Compare YTC vs YTM to assess call risk premium and make informed investment decisions.</p>
        </CardContent>
      </Card>
    </div>
  );
