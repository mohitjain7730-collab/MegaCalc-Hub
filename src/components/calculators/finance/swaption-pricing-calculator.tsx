...
import { Activity, TrendingUp, AlertCircle, Target, Info, Landmark, Calculator, DollarSign, Shield, Clock, FunctionSquare, CheckCircle2, Waves, ArrowRightLeft } from 'lucide-react';
