    ...
    <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <Card className="h-full">
              <CardHeader>
                ...
                <CardDescription>Financial health opportunities</CardDescription>
              </CardHeader>
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>The Interest Coverage Ratio Calculator assesses a company's ability to pay interest on its outstanding debt.</p>
          <p>It is a key indicator of financial solvency and creditworthiness.</p>
          <p>Use this tool to evaluate financial stability and determining the safety margin for debt service payments.</p>
        </CardContent>
      </Card>
    </div>
  );
