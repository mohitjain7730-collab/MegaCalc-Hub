...
const baseUrl = 'https://mycalculating.com/finance/weighted-average-exit-multiple-calculator';
  ...
  return (
    <div className="space-y-8">
      ...
      >
        ...
        <meta itemProp="url" content="/weighted-average-exit-multiple-calculator" />
