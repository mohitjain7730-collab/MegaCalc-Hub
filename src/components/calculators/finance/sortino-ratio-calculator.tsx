...
import { TrendingDown, AlertCircle, Target, Info, Landmark, Calculator, DollarSign, BarChart3, Shield, Activity, FunctionSquare, CheckCircle2 } from 'lucide-react';
    ...
    <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <Card className="h-full">
              <CardHeader>
                ...
                <CardDescription>Downside risk optimization opportunities</CardDescription>
              </CardHeader>
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>The Sortino Ratio Calculator measures risk-adjusted performance by focusing only on downside volatility.</p>
          <p>It provides a more relevant measure for investors primarily concerned about avoiding losses rather than overall volatility.</p>
          <p>Use this tool to evaluate fund managers, compare strategies, and optimize portfolios for downside protection.</p>
        </CardContent>
      </Card>
    </div>
  );
