...
import { Percent, AlertCircle, Target, Info, Landmark, Calculator, DollarSign, TrendingUp, Shield, Award, FunctionSquare, CheckCircle2 } from 'lucide-react';
    ...
    <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <Card className="h-full">
              <CardHeader>
                ...
                <CardDescription>Profitability optimization opportunities</CardDescription>
              </CardHeader>
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground mt-2">
            Measures the percentage of remaining revenue after all expenses, including taxes and interest, have been deducted from total sales.
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Link href="/gross-margin-calculator" className="group">
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>The Net Profit Margin Calculator determines your company's overall profitability.</p>
          <p>It helps assess how much profit is generated from each dollar of revenue after accounting for all expenses.</p>
          <p>Use this tool to evaluate financial health, manage costs, and benchmark performance against industry standards.</p>
        </CardContent>
      </Card>
    </div>
  );
