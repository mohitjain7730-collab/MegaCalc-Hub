      ...
      <Accordion type="single" collapsible className="w-full">
        ...
        <AccordionItem value="how-it-works">
         ...
         <AccordionItem value="further-reading">
            ...
            <AccordionContent className="text-muted-foreground">
                 <a href="https://www.sec.gov/oiea/investor-alerts-and-bulletins/ib_understanding-financial-ratios" target="_blank" rel="noopener noreferrer" className="text-primary underline">U.S. SEC – Income Statement Ratios</a>
            </AccordionContent>
        </AccordionItem>
      </Accordion>
    </div>
