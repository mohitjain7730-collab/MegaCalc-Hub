...
import { Landmark, DollarSign, TrendingUp, Calendar, Target, Info, AlertCircle, Building, Users, Activity, Shield } from 'lucide-react';
...
export default function RetirementSavingsCalculator() {
  ...
  const recommendationItems = result
    ? [
      result.yearsToRetirement < 10
        ? 'You are approaching retirement. Shift focus from high-growth to capital preservation.'
        : 'You have a long runway. Leverage high-growth assets to maximize compound interest.',
      result.isOnTrack
        ? 'You are on track! Consider increasing your target corpus to account for higher lifestyle costs.'
        : `You may have a shortfall. Consider increasing your monthly contribution or delaying retirement by 1-2 years.`,
      'Ensure you are maximizing employer 401(k) matches before other investments.',
      `Review your withdrawal rate. A 4% annual withdrawal is standard, but 3% offers more safety.`
    ]
    : [];
  ...
  const actionPlanItems = result
    ? [
      {
        label: 'Boost',
        detail: 'Increase your contribution by 1% of your salary every year to beat inflation.',
      },
      {
        label: 'Optimize',
        detail: 'Max out tax-advantaged accounts (401k/IRA) to reduce your current tax burden.',
      },
      {
        label: 'Diversify',
        detail: 'Ensure your portfolio has a mix of equities and bonds suitable for your age risk profile.',
      },
      {
        label: 'Review',
        detail: 'Rebalance your portfolio annually to maintain your target asset allocation.',
      },
    ]
    : [];
      ...
      <div className="space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="p-4 bg-muted/50 rounded-lg space-y-2">
              <p className="font-mono text-center text-sm md:text-base font-bold text-primary">
            ...
            <div className="text-sm text-muted-foreground space-y-2">
              ...
              <ul className="list-disc pl-4 space-y-1">
                <li><strong>FV</strong> = Future Value (Retirement Corpus)</li>
                <li><strong>P</strong> = Current Savings</li>
                <li><strong>PMT</strong> = Monthly Contribution</li>
                <li><strong>r</strong> = Monthly Interest Rate (Annual Rate ÷ 12 ÷ 100)</li>
                <li><strong>n</strong> = Total Months to Retirement</li>
              </ul>
              <p className="mt-2">
        ...
        <Card>
          ...
          <CardContent className="space-y-2 text-sm text-muted-foreground">
            <p>This tool models retirement value using current savings, monthly contributions, and expected returns to show future corpus and required savings.</p>
            ...
            <p>Use early starts, consistent contributions, and inflation-adjusted targets to secure financial independence.</p>
          </CardContent>
        </Card>
      </div>
    </div>
