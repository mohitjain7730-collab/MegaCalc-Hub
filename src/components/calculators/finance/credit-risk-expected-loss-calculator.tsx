...
import { AlertTriangle, TrendingUp, AlertCircle, Target, Info, Landmark, Calculator, DollarSign, BarChart3, Shield, PieChart, FunctionSquare, CheckCircle2, Scale } from 'lucide-react';
