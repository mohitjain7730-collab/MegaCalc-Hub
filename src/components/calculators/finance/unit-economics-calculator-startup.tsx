...
import { BarChart3, DollarSign, Target, Info, Calculator, Shield, Users, Briefcase, AlertTriangle, CheckCircle2, FunctionSquare, TrendingUp, TimerReset, UserPlus } from 'lucide-react';
