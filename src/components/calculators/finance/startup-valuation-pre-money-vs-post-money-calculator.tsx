...
const baseUrl = 'https://mycalculating.com/finance/startup-valuation-pre-money-vs-post-money-calculator';
...
const calculateResult = (values: FormValues): ResultPayload => {
  ...
  let interpretation = 'Post-money = pre-money + investment. Investor % = investment Ã· post-money. Use this to compare how different pre-money valuations affect ownership for the same check size.';
  ...
  const recommendations: string[] = [
    ...
    'Pre-money vs post-money: pre-money is the value before the round; post-money = pre-money + investment. Investor % is always investment Ã· post-money.',
  ];
  ...
  insights.push('Price per 1% = investment Ã· investor %; useful for comparing rounds');
  ...
  return (
    <div className="space-y-8">
            ...
            <form onSubmit={form.handleSubmit((values) => setResult(calculateResult(values)))} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Compare: Pre-money ($) â€” optional</FormLabel>
                      <FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Compare: Investment ($) â€” optional</FormLabel>
                      <FormControl>
                        <Input type="number" step="1" placeholder="e.g. 2000000" value={field.value ?? ''} onChange={(e) => field.onChange(e.target.value === '' ? undefined : Number(e.target.value))} />
                      </FormControl>
                      <FormMessage />
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-4 bg-amber-50 dark:bg-amber-900/10 rounded-lg border border-amber-100 dark:border-amber-900/20">
              ...
              <p className="text-sm text-muted-foreground mb-3">The amount the investor invests. Investor ownership % = investment Ã· post-money. Same check at higher pre-money gives investor a smaller %.</p>
              <ul className="space-y-2">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="p-4 bg-muted rounded-lg overflow-x-auto">
            ...
            <p className="font-mono text-sm text-center mt-2">Investor % = Investment Ã· Post-money Ã— 100</p>
            <p className="font-mono text-sm text-center mt-2">Price per 1% = Investment Ã· Investor %</p>
          </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <Link href="/startup-valuation-post-money-pre-money-calculator" className="block">
              <Card className="hover:shadow-md transition-shadow cursor-pointer">
                <CardContent className="p-4">
                  <div className="flex items-center gap-3">
            ...
            <Link href="/pre-money-vs-post-money-valuation-calculator" className="block">
              <Card className="hover:shadow-md transition-shadow cursor-pointer">
                <CardContent className="p-4">
                  <div className="flex items-center gap-3">
            ...
            <Link href="/equity-split-calculator-for-co-founders" className="block">
              <Card className="hover:shadow-md transition-shadow cursor-pointer">
                <CardContent className="p-4">
                  <div className="flex items-center gap-3">
      ...
      <section className="space-y-6 text-muted-foreground leading-relaxed bg-card p-6 md:p-10 rounded-lg shadow-lg" itemScope itemType="https://schema.org/Article">
        ...
        <p className="text-lg italic text-muted-foreground">Compare pre-money and post-money valuation: post-money = pre-money + investment; investor % = investment Ã· post-money. Use this to see how different pre-money valuations affect ownership for the same check.</p>
        ...
        <p>Pre-money valuation is the value of the company immediately before the investment. Post-money valuation = pre-money + investment. The investor receives a percentage equal to investment Ã· post-money. Comparing pre-money vs post-money helps you see how the same check size results in different ownership at different pre-money valuations.</p>
        ...
        <div className="overflow-x-auto my-6 p-4 bg-muted border rounded-lg text-center">
          ...
          <p className="font-mono text-lg text-destructive font-bold mt-2">Investor % = Investment Ã· Post-money Ã— 100</p>
          <p className="font-mono text-lg text-destructive font-bold mt-2">Price per 1% = Investment Ã· Investor %</p>
        </div>
        ...
        <p>Investor ownership in the 15â€“30% range is common for many seed and Series A rounds. Higher investor % means more dilution to founders; lower investor % means the investor is paying a higher price per 1%. Use the comparison scenario to see how changing pre-money or investment affects ownership.</p>
        <h3 className="text-xl font-semibold text-foreground mt-6">Typical Ranges by Stage</h3>
        <p>Seed rounds often give investors 15â€“25%; Series A often 15â€“25% as well, though round size and valuation vary by market and traction. Use this calculator to see where your scenario lands and compare with a second scenario (e.g. higher pre-money, same check) to understand the trade-off.</p>
        <hr />
        ...
        <CardContent>
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Post-money valuation is the value of the company after the investment. Post-money = pre-money + investment. Investor ownership % = investment Ã· post-money. The post-money valuation is often cited in press and cap tables to describe the size of the round.</p>
            </div>
            <div>
              ...
              <p className="text-muted-foreground">The same investment at a higher pre-money gives the investor a smaller percentage (less dilution to founders). For example, $2M at $8M pre = 20% investor; $2M at $18M pre â‰ˆ 10% investor.</p>
            </div>
            <div>
              <h4 className="font-semibold text-lg mb-3">What is price per 1%?</h4>
              <p className="text-muted-foreground">Price per 1% = investment Ã· investor %. It is the amount paid for each percentage point of the company. Useful for comparing rounds or different term sheets.</p>
            </div>
            <div>
              <h4 className="font-semibold text-lg mb-3">What investor % is typical?</h4>
              <p className="text-muted-foreground">Many seed rounds give investors 15â€“25%; Series A often 15â€“25%. It varies by market, traction, and round size. Use this calculator to see where your scenario lands. Higher investor % means more dilution to founders; lower investor % means the investor is paying a higher price per 1% of the company.</p>
            </div>
            <div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="p-4 rounded-lg bg-green-50 dark:bg-green-900/10 border border-green-100 dark:border-green-900/20">
                ...
                <p className="text-sm text-muted-foreground">$10M pre-money + $2M investment â†’ Post-money $12M. Investor % = 2/12 â‰ˆ 16.7%. Price per 1% = $2M Ã· 16.7 â‰ˆ $120K. Compare: $15M pre + $2M â†’ Post $17M, investor â‰ˆ 11.8%. Same check, higher pre-money, less dilution.</p>
              </div>
              <div className="p-4 rounded-lg bg-blue-50 dark:bg-blue-900/10 border border-blue-100 dark:border-blue-900/20">
                <h5 className="font-semibold text-blue-800 dark:text-blue-300 mb-1">Case B: Series A</h5>
                <p className="text-sm text-muted-foreground">$30M pre-money + $10M investment â†’ Post-money $40M. Investor % = 10/40 = 25%. Price per 1% = $400K. Use the comparison scenario to see what happens at $35M pre + $10M (investor â‰ˆ 22.2%) to understand the dilution trade-off.</p>
              </div>
            </div>
          </div>
        </CardContent>
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>The Startup Valuation (Pre-Money vs Post-Money) Calculator compares pre-money and post-money valuation: post-money = pre-money + investment, investor % = investment Ã· post-money, and price per 1%.</p>
