    ...
    <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <Card className="h-full">
              <CardHeader>
                ...
                <CardDescription>Portfolio simulation opportunities</CardDescription>
              </CardHeader>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="p-4 bg-muted/50 rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">Starting portfolio value for simulation.</p>
            </div>
            <div className="p-4 bg-muted/50 rounded-lg">
              <h4 className="font-semibold mb-2 flex items-center gap-2">
              ...
              <p className="text-sm text-muted-foreground">Annualized expected portfolio return.</p>
            </div>
            <div className="p-4 bg-muted/50 rounded-lg">
              <h4 className="font-semibold mb-2 flex items-center gap-2">
              ...
              <p className="text-sm text-muted-foreground">Annualized standard deviation of returns.</p>
            </div>
            <div className="p-4 bg-muted/50 rounded-lg">
              <h4 className="font-semibold mb-2 flex items-center gap-2">
              ...
              <p className="text-sm text-muted-foreground">Investment period to simulate.</p>
            </div>
            <div className="p-4 bg-muted/50 rounded-lg">
              <h4 className="font-semibold mb-2 flex items-center gap-2">
              ...
              <p className="text-sm text-muted-foreground">Number of random trials to run (more = accurate).</p>
            </div>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-4">
          <div className="p-4 bg-muted rounded-lg overflow-x-auto">
            <p className="font-mono text-sm text-center">
              St+1 = St × e^[(μ - σ²/2)Δt + σZ√Δt]
            </p>
          </div>
          <p className="text-sm text-muted-foreground mt-2">
            Geometric Brownian Motion simulates price paths using expected return (μ), volatility (σ), and random normal variable (Z).
          </p>
        </CardContent>
      </Card>
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>Monte Carlo simulation projects portfolio value distributions using random sampling and statistical analysis.</p>
          <p>It models thousands of potential scenarios to quantify risk and forecast outcomes under uncertainty.</p>
          <p>Use this tool for retirement planning, risk assessment, and understanding portfolio probability distributions.</p>
        </CardContent>
      </Card>
    </div>
  );
