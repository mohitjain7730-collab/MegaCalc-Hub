      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              { name: "Mortgage Payment", url: "/mortgage-payment-calculator", icon: <Home className="h-5 w-5 text-indigo-500" />, desc: "Standard P&I Calculation" },
              { name: "Amortization Schedule", url: "/amortization-schedule-generator", icon: <Calendar className="h-5 w-5 text-blue-500" />, desc: "Year-by-year breakdown" },
              { name: "Home Affordability", url: "/home-affordability-calculator", icon: <Shield className="h-5 w-5 text-green-500" />, desc: "What can you borrow?" },
              { name: "DTI Calculator", url: "/dscr-calculator", icon: <Percent className="h-5 w-5 text-red-500" />, desc: "Loan qualification check" },
            ].map((item, i) => (
