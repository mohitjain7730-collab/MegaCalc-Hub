      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              { name: "Debt Repayment", url: "/debt-snowball-avalanche-repayment-calculator", icon: <TrendingUp className="h-5 w-5 text-indigo-500" />, desc: "Plan your payoff strategy" },
              { name: "Home Affordability", url: "/home-affordability-calculator", icon: <Shield className="h-5 w-5 text-green-500" />, desc: "See what DTI allows you to buy" },
              { name: "Credit Card Payoff", url: "/credit-card-payoff-calculator", icon: <CreditCard className="h-5 w-5 text-red-500" />, desc: "Eliminate revolving debt" },
              { name: "Emergency Fund", url: "/emergency-fund-calculator", icon: <Shield className="h-5 w-5 text-blue-500" />, desc: "Safety net sizing" },
              { name: "Savings Goal", url: "/savings-goal-timeline-calculator", icon: <DollarSign className="h-5 w-5 text-purple-500" />, desc: "Plan for big purchases" },
              { name: "Loan Amortization", url: "/amortization-schedule-generator", icon: <BarChart className="h-5 w-5 text-amber-500" />, desc: "Understand interest costs" },
            ].map((item, i) => (
