      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="p-4 border rounded"><h4 className="font-semibold mb-1"><Link href="/earnings-per-share-calculator" className="text-primary hover:underline">Earnings per Share</Link></h4><p className="text-sm text-muted-foreground">EPS context for splits.</p></div>
            <div className="p-4 border rounded"><h4 className="font-semibold mb-1"><Link href="/price-to-earnings-ratio-calculator" className="text-primary hover:underline">P/E Ratio</Link></h4><p className="text-sm text-muted-foreground">Valuation multiple.</p></div>
