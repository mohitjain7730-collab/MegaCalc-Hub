    ...
    <div className="space-y-8">
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            <Link href="/bond-yield-to-maturity-calculator" className="block">
            ...
            <Link href="/bond-yield-spread-calculator" className="block">
              <Card className="hover:shadow-md transition-shadow">
                <CardContent className="p-4">
                  <div className="flex items-center gap-2">
            ...
            <Link href="/yield-to-call-calculator" className="block">
              <Card className="hover:shadow-md transition-shadow">
                <CardContent className="p-4">
                  <div className="flex items-center gap-2">
            ...
            <Link href="/zero-coupon-bond-valuation-calculator" className="block">
              <Card className="hover:shadow-md transition-shadow">
                <CardContent className="p-4">
                  <div className="flex items-center gap-2">
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>Bond price is the present value of all future cash flows (coupons + face value) discounted at the yield to maturity.</p>
          <p>Premium bonds trade above par when coupon exceeds YTM; discount bonds trade below par when YTM exceeds coupon.</p>
          <p>Use this calculator to determine fair value and assess if a bond offers attractive returns relative to market rates.</p>
        </CardContent>
      </Card>
    </div>
  );
