    ...
    <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <Card className="h-full">
              <CardHeader>
                ...
                <CardDescription>Cash flow optimization opportunities</CardDescription>
              </CardHeader>
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>The Free Cash Flow (FCF) Calculator determines the cash available for distribution to investors.</p>
          <p>It helps assess a company's financial flexibility, valuation, and ability to fund growth or pay dividends.</p>
          <p>Use this tool to evaluate the true cash-generating power of a business beyond accounting profits.</p>
        </CardContent>
      </Card>
    </div>
  );
