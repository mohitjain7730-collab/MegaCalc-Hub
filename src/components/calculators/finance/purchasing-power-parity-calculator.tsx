    ...
    <div className="space-y-8">
      ...
      <section className="space-y-6 text-muted-foreground leading-relaxed bg-card p-6 md:p-10 rounded-lg shadow-lg" itemScope itemType="https://schema.org/FinanceSummary">
        ...
        <ul className="list-disc ml-6 space-y-2 text-primary">
          <li><a href="#what-is-ppp" className="hover:underline">What is PPP?</a></li>
          <li><a href="#big-mac" className="hover:underline">The "Big Mac Index" Concept</a></li>
          <li><a href="#limitations" className="hover:underline">Why it Fails Short-Term</a></li>
          <li><a href="#balassa-samuelson" className="hover:underline">The Balassa-Samuelson Effect</a></li>
        </ul>
        <hr />

        <h2 id="what-is-ppp" className="text-2xl font-bold text-foreground pt-8" itemProp="articleSection">What is Purchasing Power Parity?</h2>
        ...
        <h2 id="limitations" className="text-2xl font-bold text-foreground pt-8" itemProp="articleSection">Why it Fails Short-Term</h2>
        <p>While PPP tends to hold in the very long run (5-10 years), it is terrible for day trading. Why?</p>
        <ul className="list-disc ml-6 space-y-2">
          <li><strong>Transport Costs:</strong> It costs money to ship goods to exploit arbitrage.</li>
          <li><strong>Taxes/Tariffs:</strong> Governments distort prices with duties.</li>
          <li><strong>Non-Tradables:</strong> You can't ship a haircut or an apartment rental from Mumbai to New York.</li>
        </ul>
        <hr />

        <h2 id="balassa-samuelson" className="text-2xl font-bold text-foreground pt-8" itemProp="articleSection">The Balassa-Samuelson Effect</h2>
        <p>This economic model explains why CPI is systematically higher in rich countries. High productivity in tradable sectors (like manufacturing) raises wages across the whole economy, including non-tradable sectors (like haircuts), making the overall price level higher in developed nations.</p>
      </section>
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <div>
            <h4 className="font-semibold text-lg mb-3">What is PPP?</h4>
            <p className="text-muted-foreground">
              Purchasing Power Parity (PPP) is the theory that exchange rates should adjust so that a basket of goods has the same real price in different countries.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              PPP Rate = Cost of Good (Domestic Currency) / Cost of Good (Foreign Currency). This gives you the "fair value" exchange rate implied by the price difference.
            </p>
          </div>

          <div>
            <h4 className="font-semibold text-lg mb-3">What is the "Iceberg Cost" model?</h4>
            <p className="text-muted-foreground">
              An economic concept used to explain deviations from PPP. It assumes that a fraction of the good assumes to "melt" during transit (transport costs), creating a natural price band where no arbitrage is possible.
            </p>
          </div>

          <div>
            <h4 className="font-semibold text-lg mb-3">What is Relative vs. Absolute PPP?</h4>
            <p className="text-muted-foreground">
              <strong>Absolute PPP:</strong> Compares price levels at a snapshot in time.<br />
              <strong>Relative PPP:</strong> Compares inflation rates over time. It says the currency with higher inflation will depreciate by the differential.
            </p>
          </div>

          <div>
            <h4 className="font-semibold text-lg mb-3">Is PPP good for trading?</h4>
            <p className="text-muted-foreground">
              Not for short-term trading. Currencies can remain "mispriced" relative to PPP for years (e.g., the Swiss Franc is famously overvalued for decades). It works best as a 5-10 year valuation anchor.
            </p>
          </div>

          <div>
            <h4 className="font-semibold text-lg mb-3">How does inflation impact PPP?</h4>
            <p className="text-muted-foreground">
              High domestic inflation forces the currency to weaken to maintain legal parity. If prices double but the exchange rate stays the same, domestic goods become unsellable abroad (loss of competitiveness).
            </p>
          </div>
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>The Purchasing Power Parity (PPP) Calculator accurately identifies long-term currency mispricing by comparing price levels of identical goods across borders.</p>
          <p>It provides an essential benchmark for valuing currencies beyond short-term market noise.</p>
        </CardContent>
      </Card>
    </div>
  );
