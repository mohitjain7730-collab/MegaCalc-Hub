    ...
    <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <Card className="h-full">
              <CardHeader>
                ...
                <CardDescription>Diversification opportunities</CardDescription>
              </CardHeader>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 bg-muted/50 rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                Historical periodic returns for the first asset, separated by commas.
              </p>
            </div>
            <div className="p-4 bg-muted/50 rounded-lg">
              <h4 className="font-semibold mb-2 flex items-center gap-2">
              ...
              <p className="text-sm text-muted-foreground">
                Historical periodic returns for the second asset. Must have the same number of data points as Asset 1.
              </p>
            </div>
          </div>
        </CardContent>
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground mt-2">
            Measures the linear relationship between two variables. Values range from -1 (perfect negative) to +1 (perfect positive).
          </p>
        </CardContent>
      </Card>
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>The Correlation Coefficient Calculator measures the strength and direction of the linear relationship between two assets.</p>
          <p>Low or negative correlations provide excellent diversification benefits for portfolio construction.</p>
          <p>Use this tool to identify diversification opportunities and optimize portfolio risk-return profiles.</p>
        </CardContent>
      </Card>
    </div>
  );
