    ...
    <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <Card className="h-full">
              <CardHeader>
                ...
                <CardDescription>Systematic risk opportunities</CardDescription>
              </CardHeader>
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>The Beta Asset Calculator measures systematic risk—how sensitively an asset responds to market movements.</p>
          <p>Beta = 1 indicates market-matching volatility; higher beta means more volatile, lower beta means more stable.</p>
          <p>Use this tool for CAPM calculations, portfolio construction, and risk assessment.</p>
        </CardContent>
      </Card>
    </div>
  );
