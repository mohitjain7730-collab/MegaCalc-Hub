      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              { title: "Two-Asset Allocator", desc: "Solve for precise weights", href: "/optimal-portfolio-allocation-two-asset-calculator" },
              { title: "Portfolio Variance", desc: "N-Asset risk calculation", href: "/portfolio-variance-calculator" },
              { title: "Sharpe Ratio", desc: "Historical efficiency audit", href: "/sharpe-ratio-calculator" },
              { title: "Treynor Ratio", desc: "Systemic risk-return audit", href: "/treynor-ratio-calculator" },
              { title: "CAPM Model", desc: "Expected return modeling", href: "/capm-calculator" },
              { title: "Beta Adjuster", desc: "Risk-adjusted performance", href: "/beta-adjusted-portfolio-return-calculator" },
            ].map((calc, i) => (
