...
import { TrendingUp, Calculator, DollarSign, Target, Info, AlertCircle, Calendar, BarChart, PiggyBank, ShoppingCart, Shield, FunctionSquare, CheckCircle2 } from 'lucide-react';
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <Card className="h-full">
                  <CardHeader>
                    ...
                    <CardDescription>Steps to preserve purchasing power</CardDescription>
                  </CardHeader>
                ...
                <Card className="h-full border-red-100 bg-red-50/10 dark:border-red-900/20 dark:bg-red-900/5">
                  <CardHeader>
                    ...
                    <CardDescription>Critical wealth erosion factors</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
      ...
      <div className="space-y-6">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="text-sm text-muted-foreground grid grid-cols-1 md:grid-cols-2 gap-4">
              <ul className="space-y-1">
                <li><span className="font-semibold">FV</span> = Future Value (Nominal)</li>
                <li><span className="font-semibold">PV</span> = Present Value (Current Amount)</li>
              </ul>
              <ul className="space-y-1">
                <li><span className="font-semibold">i</span> = Annual Inflation Rate (%)</li>
                <li><span className="font-semibold">n</span> = Number of Years</li>
              </ul>
            </div>
            <div className="mt-4 pt-4 border-t">
              <p className="text-sm font-medium mb-2">Purchasing Power Formula:</p>
              <p className="font-mono text-sm bg-muted p-2 rounded">Purchasing Power = PV / (1 + i)^n</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="p-4 border rounded-lg hover:bg-muted/50 transition-colors">
                <h4 className="font-semibold mb-2">
                  <a href="/real-rate-of-return-calculator" className="text-primary hover:underline">
        ...
        <Card className="mb-6">
          ...
          <CardContent className="space-y-2 text-sm text-muted-foreground">
            <p>The Inflation Calculator determines the future value of money and the erosion of purchasing power over time based on a projected annual inflation rate.</p>
            <p>It provides key metrics like Real Return and Salary Adjustment needs to help you plan for maintaining your standard of living.</p>
            <p>The tool offers actionable strategies to hedge against inflation, such as investing in growth assets and adjusting financial goals.</p>
          </CardContent>
        </Card>
      </div>
    </div>
