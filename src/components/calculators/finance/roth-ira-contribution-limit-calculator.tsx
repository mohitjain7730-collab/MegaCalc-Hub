...
import { PiggyBank, Calculator, DollarSign, TrendingUp, Info, AlertCircle, Target, Calendar, Users, Building, Shield, FunctionSquare, CheckCircle2 } from 'lucide-react';
    ...
    <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <Card className="h-full">
                  <CardHeader>
                    ...
                    <CardDescription>Optimization steps for your Roth IRA</CardDescription>
                  </CardHeader>
                ...
                <Card className="h-full border-red-100 bg-red-50/10 dark:border-red-900/20 dark:bg-red-900/5">
                  <CardHeader>
                    ...
                    <CardDescription>Rules and warnings to monitor</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
          ...
          <CardContent className="space-y-4">
            <div className="p-4 bg-muted rounded-lg overflow-x-auto">
              <p className="font-mono text-sm text-center">
                Reduction = Limit × [ (MAGI - PhaseoutStart) / PhaseoutRange ]
              </p>
            </div>
            <div className="text-sm text-muted-foreground grid grid-cols-1 md:grid-cols-2 gap-4">
              <ul className="space-y-1">
                <li><span className="font-semibold">Full Limit</span> = Standard annual contribution ($7,000/$8,000 for 2024)</li>
                <li><span className="font-semibold">Reduction</span> = Amount deducted from full limit</li>
                <li><span className="font-semibold">PhaseoutRange</span> = End - Start of income limit</li>
              </ul>
              <ul className="space-y-1">
                <li><span className="font-semibold">MAGI</span> = Modified Adjusted Gross Income</li>
                <li><span className="font-semibold">PhaseoutStart</span> = Income level where reduction begins</li>
              </ul>
            </div>
          </CardContent>
        </Card>
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>The Roth IRA Contribution Limit Calculator determines your eligibility and maximum allowed contribution based on your MAGI, filing status, and age.</p>
          <p>It calculates reduced limits for those in phase-out ranges and accounts for catch-up contributions for individuals age 50 and older.</p>
          <p>The results provide specific compliance checks and strategy recommendations, including alternative options like Traditional or Backdoor Roth IRAs if you are ineligible.</p>
        </CardContent>
      </Card>
    </div >
  );
