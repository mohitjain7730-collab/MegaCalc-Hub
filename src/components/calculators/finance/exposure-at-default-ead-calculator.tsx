...
import { Activity, TrendingUp, AlertCircle, Target, Info, Landmark, Calculator, DollarSign, BarChart3, Shield, PieChart, FunctionSquare, CheckCircle2, Wallet, Layers } from 'lucide-react';
