    ...
    <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <Card className="h-full">
              <CardHeader>
                ...
                <CardDescription>Valuation optimization opportunities</CardDescription>
              </CardHeader>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 bg-muted/50 rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                The total value of a company including market cap, debt, and minus cash. Represents the theoretical takeover price of the business.
              </p>
            </div>
            <div className="p-4 bg-muted/50 rounded-lg">
              <h4 className="font-semibold mb-2 flex items-center gap-2">
              ...
              <p className="text-sm text-muted-foreground">
                Earnings Before Interest and Taxes. Measures operating profitability before financing costs. Found on the income statement as operating income.
              </p>
            </div>
            <div className="p-4 bg-muted/50 rounded-lg">
              <h4 className="font-semibold mb-2 flex items-center gap-2">
              ...
              <p className="text-sm text-muted-foreground">
                Earnings Before Interest, Taxes, Depreciation & Amortization. A proxy for operational cash flow, excluding non-cash expenses.
              </p>
            </div>
          </div>
        </CardContent>
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground mt-2">
            These multiples compare company valuation to operating earnings, enabling cross-company and industry comparisons independent of capital structure.
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <Link href="/operating-margin-calculator" className="group">
              <Card className="group-hover:shadow-md transition-shadow">
                <CardContent className="p-4 text-center">
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>The EV/EBIT and EV/EBITDA Multiple Calculator helps assess relative valuation and investment attractiveness.</p>
          <p>These multiples enable cross-company comparisons independent of capital structure and accounting policies.</p>
          <p>Use this tool to benchmark valuations, identify investment opportunities, and support M&A analysis.</p>
        </CardContent>
      </Card>
    </div>
  );
