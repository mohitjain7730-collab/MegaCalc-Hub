                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        <div className="p-4 border rounded-lg hover:bg-muted/50 transition-colors">
                            <h4 className="font-semibold mb-2">
                                <a href="/category/finance/chronic-condition-lifetime-cost-calculator" className="text-primary hover:underline">
                                    Chronic Costs
                                </a>
                            </h4>
                        ...
                        <div className="p-4 border rounded-lg hover:bg-muted/50 transition-colors">
                            <h4 className="font-semibold mb-2">
                                <a href="/category/finance/medical-equipment-depreciation-estimator" className="text-primary hover:underline">
                                    Equipment Value
                                </a>
                            </h4>
                            <p className="text-sm text-muted-foreground">
