...
import { SlidersHorizontal, Calculator, Info, FileText, TrendingUp, Target, FunctionSquare, CheckCircle2, AlertCircle, Shield } from 'lucide-react';
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <Card className="h-full">
          <CardHeader>
            ...
            <CardDescription>Sensitivity analysis advantages</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex items-start gap-3 p-3 bg-primary/5 rounded-lg border border-primary/10">
              <CheckCircle2 className="h-5 w-5 text-primary mt-0.5 shrink-0" />
              <span className="text-sm font-medium">Identifies key drivers affecting NPV</span>
            </div>
            <div className="flex items-start gap-3 p-3 bg-primary/5 rounded-lg border border-primary/10">
              <CheckCircle2 className="h-5 w-5 text-primary mt-0.5 shrink-0" />
              <span className="text-sm font-medium">Reveals break-even thresholds for variables</span>
            </div>
            <div className="flex items-start gap-3 p-3 bg-primary/5 rounded-lg border border-primary/10">
              <CheckCircle2 className="h-5 w-5 text-primary mt-0.5 shrink-0" />
              <span className="text-sm font-medium">Guides risk mitigation priorities</span>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="h-full border-red-100 bg-red-50/10 dark:border-red-900/20 dark:bg-red-900/5">
          <CardHeader>
            ...
            <CardDescription>Critical limitations to consider</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex items-start gap-3 p-3 bg-red-50 dark:bg-red-900/10 rounded-lg border border-red-100 dark:border-red-900/20">
              ...
              <span className="text-sm font-medium text-red-800 dark:text-red-300">Tests one variable at a time only</span>
            </div>
            <div className="flex items-start gap-3 p-3 bg-red-50 dark:bg-red-900/10 rounded-lg border border-red-100 dark:border-red-900/20">
              <AlertCircle className="h-5 w-5 text-red-600 dark:text-red-400 mt-0.5 shrink-0" />
              <span className="text-sm font-medium text-red-800 dark:text-red-300">Ignores correlations between variables</span>
            </div>
            <div className="flex items-start gap-3 p-3 bg-red-50 dark:bg-red-900/10 rounded-lg border border-red-100 dark:border-red-900/20">
              <AlertCircle className="h-5 w-5 text-red-600 dark:text-red-400 mt-0.5 shrink-0" />
              <span className="text-sm font-medium text-red-800 dark:text-red-300">Use with scenario analysis for fuller picture</span>
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground mt-2">
            Varying r (discount rate) or cash flow reveals sensitivity of NPV to assumptions.
          </p>
        </CardContent>
      </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 border rounded-lg hover:bg-muted/50 transition-colors">
              <h4 className="font-semibold mb-2">
                <a href="/scenario-analysis-calculator" className="text-primary hover:underline">
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>Sensitivity analysis tests how changes in one variable affect financial outcomes.</p>
          <p>Identifies the most critical assumptions and their break-even thresholds.</p>
          <p>Best used alongside scenario analysis to capture correlations between variables.</p>
        </CardContent>
      </Card>
    </div>
  );
