      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 border rounded-lg hover:bg-muted/50 transition-colors"><h4 className="font-semibold mb-2"><a href="/portfolio-correlation-heatmap-tool" className="text-primary hover:underline">Portfolio Correlation Heatmap</a></h4><p className="text-sm text-muted-foreground">Asset correlation analysis.</p></div>
