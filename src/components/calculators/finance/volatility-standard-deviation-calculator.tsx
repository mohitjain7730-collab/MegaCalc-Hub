    ...
    <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <Card className="h-full">
              <CardHeader>
                ...
                <CardDescription>Risk assessment opportunities</CardDescription>
              </CardHeader>
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>The Volatility/Standard Deviation Calculator measures investment risk by quantifying the dispersion of returns.</p>
          <p>Higher volatility indicates greater price swings and higher risk; lower volatility suggests more stable returns.</p>
          <p>Use this tool to assess risk levels, determine position sizes, and optimize portfolio allocation.</p>
        </CardContent>
      </Card>
    </div>
  );
