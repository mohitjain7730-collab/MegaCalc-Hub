      ...
      <Card className="mb-8">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              { name: "Credit Card Payoff", url: "/category/finance/credit-card-payoff-calculator", icon: <DollarSign className="h-5 w-5 text-red-500" />, desc: "Specific plan for plastic debt" },
              { name: "Budget Planner", url: "/category/finance/monthly-budget-planner-calculator", icon: <PieChart className="h-5 w-5 text-green-500" />, desc: "Find money for extra payments" },
              { name: "Emergency Fund", url: "/category/finance/emergency-fund-calculator", icon: <Shield className="h-5 w-5 text-blue-500" />, desc: "Protect your progress" },
              { name: "Savings Goal", url: "/category/finance/savings-goal-timeline-calculator", icon: <Target className="h-5 w-5 text-indigo-500" />, desc: "Plan for life after debt" },
              { name: "Loan Amortization", url: "/category/finance/amortization-schedule-generator", icon: <Calendar className="h-5 w-5 text-purple-500" />, desc: "Deep dive into loan schedules" },
              { name: "Debt-to-Income", url: "/category/finance/dscr-calculator", icon: <Scale className="h-5 w-5 text-orange-500" />, desc: "Check your borrowing power" },
            ].map((item, i) => (
