      ...
      <Card className="shadow-xl">
        ...
        <CardContent>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { title: "Portfolio Variance", desc: "Total risk aggregation", href: "/category/finance/portfolio-variance-calculator" },
              { title: "Efficient Frontier", desc: "Optimal allocation sweep", href: "/category/finance/efficient-frontier-visualizer" },
              { title: "Sharpe Ratio", desc: "Efficiency benchmarking", href: "/category/finance/sharpe-ratio-calculator" },
              { title: "Beta Adjuster", desc: "Market sensitivity audit", href: "/category/finance/beta-adjusted-portfolio-return-calculator" }
            ].map((calc, i) => (
