...
import { Percent, AlertCircle, Target, Info, Landmark, Calculator, DollarSign, TrendingUp, Shield, BarChart3, Activity, FunctionSquare, CheckCircle2, Globe } from 'lucide-react';
    ...
    <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <Card className="h-full">
              <CardHeader>
                ...
                <CardDescription>Real return opportunities</CardDescription>
              </CardHeader>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 bg-muted/50 rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">The stated or reported interest rate before inflation adjustment.</p>
            </div>
            <div className="p-4 bg-muted/50 rounded-lg">
              <h4 className="font-semibold mb-2 flex items-center gap-2">
              ...
              <p className="text-sm text-muted-foreground">The annual rate of price increase (e.g., CPI).</p>
            </div>
          </div>
        </CardContent>
      </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 border rounded-lg hover:bg-muted/50 transition-colors">
              <h4 className="font-semibold mb-2">
                <Link href="/category/finance/simple-inflation-adjusted-return-calculator" className="text-primary hover:underline">
            ...
            <div className="p-4 border rounded-lg hover:bg-muted/50 transition-colors">
              ...
              <p className="text-sm text-muted-foreground">
                Calculate impact of inflation on purchasing power.
              </p>
            </div>
          </div>
        </CardContent>
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>Real rate of return measures true purchasing power growth by adjusting nominal returns for inflation.</p>
          <p>Use the Fisher equation for accurate calculation: (1 + Nominal) / (1 + Inflation) - 1.</p>
