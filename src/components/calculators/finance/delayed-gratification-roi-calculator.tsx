        ...
        <Card>
          ...
          <CardContent>
            <ul className="list-disc pl-5 text-sm text-primary">
              <li><Link href="/compound-interest-calculator" className="hover:underline">Sinking Fund Calculator</Link></li>
              <li><Link href="/compound-interest-calculator" className="hover:underline">Subscription Audit Calculator</Link></li>
              <li><Link href="/compound-interest-calculator" className="hover:underline">Lifestyle Creep Calculator</Link></li>
              <li><Link href="/compound-interest-calculator" className="hover:underline">Opportunity Cost Calculator</Link></li>
            </ul>
          </CardContent>
        </Card>
