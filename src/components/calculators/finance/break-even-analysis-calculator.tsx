...
import { Activity, AlertCircle, TrendingUp, DollarSign, Calculator, Target, BarChart3, CheckCircle2, Shield, AlertTriangle, Layers, BookOpen, Warehouse, Factory } from 'lucide-react';
