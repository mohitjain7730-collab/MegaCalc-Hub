...
import { Calculator, DollarSign, TrendingDown, Info, AlertCircle, Target, Calendar, BarChart, TrendingUp, Shield, FunctionSquare, CheckCircle2 } from 'lucide-react';
    ...
    <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <Card className="h-full">
                  <CardHeader>
                    ...
                    <CardDescription>Key takeaways from your analysis</CardDescription>
                  </CardHeader>
                ...
                <Card className="h-full border-red-100 bg-red-50/10 dark:border-red-900/20 dark:bg-red-900/5">
                  <CardHeader>
                    ...
                    <CardDescription>Factors affecting your valuation</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>The Present Value Calculator determines the current worth of a future lump sum or stream of cash flows (annuity) by discounting them at a specified rate.</p>
          <p>It helps in evaluating investment opportunities, comparing cash flow options, and understanding the time value of money impact on your wealth.</p>
          <p>The tool provides year-by-year value reduction breakdowns and actionable recommendations based on your discount rate and risk profile.</p>
        </CardContent>
      </Card>
    </div>
