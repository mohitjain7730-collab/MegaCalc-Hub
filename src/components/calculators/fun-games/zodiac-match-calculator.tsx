        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Button
              ...
              onClick={() => router.push('/love-percentage-calculator')}
            >
            ...
            <Button
              ...
              onClick={() => router.push('/crush-compatibility-calculator')}
            >
            ...
            <Button
              ...
              onClick={() => router.push('/friendship-compatibility-calculator')}
            >
            ...
            <Button
              ...
              onClick={() => router.push('/name-compatibility-calculator')}
            >
