  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-4 prose prose-sm dark:prose-invert max-w-none">
        ...
        <h4 className='font-bold'>How Glove Sizes Are Measured</h4>
        <p className="text-sm">Glove sizes are determined by the circumference of your dominant hand (excluding the thumb). Measurements can be taken in inches or centimeters.</p>
        <ul className="list-disc list-inside text-sm space-y-1 pl-4">
        ...
        <h4 className='font-bold'>Using a Glove Size Converter</h4>
        <p className="text-sm">A glove size converter makes converting your measurement easy:</p>
        <ol className="list-decimal list-inside text-sm space-y-1 pl-4">
        ...
        <h4 className='font-bold'>Tips for Choosing the Right Glove</h4>
        <ul className="list-disc list-inside text-sm space-y-1 pl-4">
        ...
        <h4 className='font-bold'>Benefits of Using a Glove Size Converter</h4>
        <ul className="list-disc list-inside text-sm space-y-1 pl-4">
        ...
        <h4 className='font-bold'>FAQ: Glove Size</h4>
        <p className="text-sm"><strong>Q1: How do I know my US glove size if I know my EU size?</strong><br/>Use a glove size converter. Typically, US/UK sizes are slightly smaller than EU sizes in centimeters.</p>
        <p className="text-sm"><strong>Q2: Can I wear one size for men and women?</strong><br/>Gloves are generally unisex, but sizing may differ. Always measure your hand for the most accurate fit.</p>
        <p className="text-sm"><strong>Q3: What if my measurement is between sizes?</strong><br/>Choose the larger size for comfort, especially for winter or work gloves.</p>
        <p className="text-sm"><strong>Q4: Are India glove sizes reliable?</strong><br/>India sizes are approximate but usually based on EU size minus 1 cm. A converter ensures accuracy.</p>
