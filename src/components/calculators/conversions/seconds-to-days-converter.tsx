      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="space-y-2">
            <p><Link href="/conversions/days-to-seconds-converter" className="text-primary underline">Days to Seconds Converter</Link></p>
            <p><Link href="/conversions/seconds-to-weeks-converter" className="text-primary underline">Seconds to Weeks Converter</Link></p>
          </div>
        </div>
      </div>
    </div>
