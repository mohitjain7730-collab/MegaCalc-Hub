        ...
        <div>
         ...
         <div>
          ...
          <div className="space-y-2">
            <p><Link href="/weeks-to-months-converter" className="text-primary underline">Weeks to Months Converter</Link></p>
            <p><Link href="/months-to-years-converter" className="text-primary underline">Months to Years Converter</Link></p>
          </div>
        </div>
      </div>
    </div>
