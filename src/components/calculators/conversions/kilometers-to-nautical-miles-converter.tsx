        ...
        <AccordionItem value="faq">
          ...
          <AccordionContent className="text-muted-foreground space-y-4">
            <div>
              ...
              <p>A nautical mile is a unit of measurement used in air and marine navigation. It is based on the circumference of the Earth and is equal to one minute of latitude. It is internationally defined as 1,852 meters (1.852 kilometers).</p>
            </div>
          </AccordionContent>
        </AccordionItem>
      </Accordion>
