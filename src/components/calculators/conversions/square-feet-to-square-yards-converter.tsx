...
const formSchema = z.object({
  sqFeet: z.coerce.number().positive('Must be a positive number'),
});
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="space-y-2">
            <p><Link href="/square-yards-to-square-feet-converter" className="text-primary underline">Square Yards to Square Feet Converter</Link></p>
            <p><Link href="/square-meters-to-square-feet-converter" className="text-primary underline">Square Meters to Square Feet Converter</Link></p>
          </div>
        </div>
      </div>
    </div>
