...
const formSchema = z.object({
  hectares: z.coerce.number().positive('Must be a positive number'),
});
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="space-y-2">
            <p><Link href="/square-kilometers-to-hectares-converter" className="text-primary underline">Square Kilometers to Hectares Converter</Link></p>
