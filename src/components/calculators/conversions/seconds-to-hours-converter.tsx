      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="space-y-2">
            <p><Link href="/hours-to-seconds-converter" className="text-primary underline">Hours to Seconds Converter</Link></p>
            <p><Link href="/seconds-to-minutes-converter" className="text-primary underline">Seconds to Minutes Converter</Link></p>
          </div>
        </div>
      </div>
    </div>
