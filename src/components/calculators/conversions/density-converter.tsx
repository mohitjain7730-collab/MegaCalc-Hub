        ...
        <Card>
          ...
          <CardContent>
            <ul className="list-disc pl-5 text-sm text-primary">
                <li><Link href="/category/conversions/miles-per-hour-to-feet-per-second-converter" className="hover:underline">Miles Per Hour To Feet Per Second Converter</Link></li>
                ...
                <li><Link href="/category/conversions/nanometers-to-meters-converter" className="hover:underline">Nanometers To Meters Converter</Link></li>
                <li><Link href="/category/conversions/temperature-converter" className="hover:underline">Temperature Converter</Link></li>
                <li><Link href="/category/conversions/square-yards-to-square-feet-converter" className="hover:underline">Square Yards To Square Feet Converter</Link></li>
            </ul>
          </CardContent>
        </Card>
