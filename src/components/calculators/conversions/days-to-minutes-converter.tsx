      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="space-y-2">
            <p><Link href="/minutes-to-days-converter" className="text-primary underline">Minutes to Days Converter</Link></p>
            <p><Link href="/days-to-hours-converter" className="text-primary underline">Days to Hours Converter</Link></p>
          </div>
        </div>
      </div>
    </div>
