      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="space-y-2">
            <p><Link href="/short-tons-us-to-metric-tons-converter" className="text-primary underline">Short Tons to Metric Tons Converter</Link></p>
            <p><Link href="/tons-metric-to-pounds-converter" className="text-primary underline">Metric Tons to Pounds Converter</Link></p>
          </div>
        </div>
      </div>
    </div>
