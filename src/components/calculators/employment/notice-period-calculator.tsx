                ...
                <Card>
                    ...
                    <CardContent>
                        <ul className="list-disc pl-5 text-sm text-primary">
                            <li><Link href="/category/employment/last-working-day-calculator" className="hover:underline">Last Working Day Calculator</Link></li>
                            <li><Link href="/category/employment/probation-period-calculator" className="hover:underline">Probation Period End Date Calculator</Link></li>
                        </ul>
                    </CardContent>
                </Card>
