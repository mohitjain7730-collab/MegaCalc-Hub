...
export default function SplitShiftHoursCalculator() {
    ...
    const onSubmit = (values: FormValues) => {
        ...
        // Break is from shift 1 end to shift 2 start
                ...
                <Card>
                    ...
                    <CardContent>
                        <ul className="list-disc pl-5 text-sm text-primary">
                            <li><Link href="/category/employment/night-shift-duration-calculator" className="hover:underline">Night Shift Duration Calculator</Link></li>
                        </ul>
                    </CardContent>
                </Card>
