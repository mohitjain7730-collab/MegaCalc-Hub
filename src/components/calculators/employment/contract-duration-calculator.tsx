                ...
                <Card>
                    ...
                    <CardContent>
                        <ul className="list-disc pl-5 text-sm text-primary">
                            <li><Link href="/category/employment/notice-period-calculator" className="hover:underline">Notice Period End Date Calculator</Link></li>
