                ...
                <Card>
                    ...
                    <CardContent>
                        <ul className="list-disc pl-5 text-sm text-primary">
                            <li><Link href="/category/employment/shift-rotation-calculator" className="hover:underline">Shift Rotation Calculator</Link></li>
                            <li><Link href="/category/employment/split-shift-hours-calculator" className="hover:underline">Split Shift Hours Calculator</Link></li>
                        </ul>
                    </CardContent>
                </Card>
