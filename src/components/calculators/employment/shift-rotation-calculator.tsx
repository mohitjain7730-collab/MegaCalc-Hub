            ...
            {result && (
                <Card>
                    ...
                    <CardContent>
                        ...
                        />
                        <div className="flex items-center space-x-4 mt-4 text-sm justify-center">
                ...
                <Card>
                    ...
                    <CardContent>
                        <ul className="list-disc pl-5 text-sm text-primary">
                            ...
                            <li><Link href="/category/employment/employment-anniversary-calculator" className="hover:underline">Employment Anniversary Calculator</Link></li>
                        </ul>
                    </CardContent>
                </Card>
